							...
							<form id="msform">
								...
								<fieldset ng-show="step1 == true">
										...
										<div class="row">
											...
											<!-- <div class="col-xs-12 col-sm-12 col-md-12">
												...
												<div class="form-group">
													...
													<span class="addon" style="font-size: 18px;">{{lang.patientid}}<sup style="color:red">*</sup></span>
											...
											<div class="row">
													...
													<div class="form-group transparent-placeholder" style="display: flex; flex-direction: column; position: relative;">
														...
														<div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
															<input class="form-control" ng-model="feedback.initial_assessment_hr1" max="{{todayDateTime}}" onclick="this.showPicker && this.showPicker()"
																onfocus="this.showPicker && this.showPicker()" oninput="restrictYearLength(this)" type="datetime-local" id="formula_para1_hr" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid #ced4da;margin-top:9px;width: calc(100% - 26px);" />
												...
												<div class="col-xs-12 col-sm-12 col-md-12">
													...
													<div class="form-group">
														...
														<span class="addon" style="font-size: 18px;margin-left: 15px;">{{lang.test_name}}<sup style="color:red">*</sup></span>
												...
												<div class="col-xs-12 col-sm-12 col-md-12">
													...
													<div class="form-group">
														...
														<span class="addon" style="font-size: 18px;margin-left: 15px;">{{lang.treatment_name}}<sup style="color:red">*</sup></span>
													...
													<div class="form-group transparent-placeholder" style="display: flex; flex-direction: column; position: relative;">
														...
														<div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
															<input class="form-control" ng-model="feedback.initial_assessment_hr2" max="{{todayDateTime}}" onclick="this.showPicker && this.showPicker()"
																onfocus="this.showPicker && this.showPicker()" oninput="restrictYearLength(this)" type="datetime-local" id="formula_para1_hr" ng-required="true" autocomplete="off" style="padding-top: 2px;padding-left: 6px; border: 1px solid #ced4da;margin-top:9px;width: calc(100% - 26px);" />
															<span class="calendar-icon-container" style="position: absolute; right: 5px; top: 76%; transform: translateY(-50%); margin-left:-29px;">
																<svg class="calendar-icon" style="margin-left:-42px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
																	<path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zm0 1V1h8v-.5a.5.5 0 0 1 1 0V1h1a1 1 0 0 1 1 1v2H1V2a1 1 0 0 1 1-1h1V.5a.5.5 0 0 1 1 0V1zm-2 4v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V5H1z" />
																</svg>
									...
									<div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:16px; margin-top: 17px;">
										<div class="form-group transparent-placeholder" style="display: flex; flex-direction: column; position: relative;">
											<span class="addon" style="font-size: 18px; text-align:left; margin-bottom: -3px;margin-left:-19px;">{{lang.complaint}}<sup style="color:red">*</sup></span>
											<span class="has-float-label">
									...
									<!-- submit button -->
									<input type="button" name="previous" class="previous action-button-previous" style=" font-size:small;margin-left:12px;margin-top:40px;" ng-click="prev1()" value="{{lang.previous}}" />
