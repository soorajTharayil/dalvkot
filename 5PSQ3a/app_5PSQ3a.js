...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateAbbreviationErrorRate = function () {
      ...
      var abbreviationErrorRate;
      if (chartsReviewed === 0) {
        abbreviationErrorRate = 0; // avoid division by zero
      } else {
        abbreviationErrorRate = (chartsWithErrors / chartsReviewed) * 100;
      }
