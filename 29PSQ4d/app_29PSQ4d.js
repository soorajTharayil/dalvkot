...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateNearMissesRate = function () {
      ...
      var nearMisses = document.getElementById("formula_para1").value;

      // Get the number of incidents reported
      var incidentsReported = document.getElementById("formula_para2").value;
      ...
      incidentsReported = parseInt(incidentsReported);
      ...
      if (nearMisses === 0 && incidentsReported === 0) {
        ...
        // Calculate the percentage of near misses safely
        $scope.calculatedResult = (
          (nearMisses / (incidentsReported || 1)) *
          100
        ).toFixed(2);
      }
