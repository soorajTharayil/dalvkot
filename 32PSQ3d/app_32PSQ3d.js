...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateComplianceRate = function () {
      ...
      var prescriptionsInCapitals =
        document.getElementById("formula_para1").value;

      // Get the total number of prescriptions
      var totalPrescriptions = document.getElementById("formula_para2").value;

      // Alert if inputs are empty
      if (prescriptionsInCapitals === "") {
      ...
      // Convert to integers
      prescriptionsInCapitals = parseInt(prescriptionsInCapitals);
      ...
      if (prescriptionsInCapitals === 0 && totalPrescriptions === 0) {
        ...
        $scope.calculatedResult = (
          (prescriptionsInCapitals / (totalPrescriptions || 1)) *
          100
        ).toFixed(2);
      }
