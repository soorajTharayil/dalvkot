...
$scope.setupapplication1 = function () {
	...
	$scope.savefeedback = function () {
		...
		function isFeedbackValid() {
			...
			if ((!$scope.feedback.gloves || !$scope.feedback.mask)) {
		...
		$http.post($rootScope.baseurl_main + '/savepatientfeedback_return_to_icu.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
