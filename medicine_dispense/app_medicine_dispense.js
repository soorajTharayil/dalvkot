...
app.controller('PatientFeedbackCtrl', function ($rootScope, $scope, $http, $location, $window) {
	...
	$scope.savefeedback = function () {
		...
		function isFeedbackValid() {
			...
			if ($scope.feedback.medicinename == '' || $scope.feedback.medicinename == undefined) {
				alert('Please enter medicine name');
				return false;
			}
			// if ((!$scope.feedback.gloves || !$scope.feedback.mask || !$scope.feedback.cap )) {
		...
		$http.post($rootScope.baseurl_main + '/savepatientfeedback_medicine_dispense.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
