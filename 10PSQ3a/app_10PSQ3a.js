...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateICUSMR = function () {
      ...
      // If denominator is zero → result = 0 instead of dividing
      var icuSMR = 0;

      if (predictedDeathsInICU !== 0) {
        icuSMR = (actualDeathsInICU / predictedDeathsInICU) * 100;
      }
