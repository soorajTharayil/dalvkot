...
class Doctor extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->session->set_userdata([
            'active_menu' => array('doctor_dashboard', 'doctor_ticket', 'doctor_reports', 'doctor_patients', 'doctor_settings', 'doctor_dep', 'doctor_analysis'),
        ]);
        // if (ismodule_active('DOCTOR') === false  && $this->uri->segment(2) != 'track')
    ...
    public function index()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {

            $data['title'] = 'DOCTOR MODULE CONFIGURATION';
            $data['content'] = $this->load->view('doctormodules/developer', $data, true);
    ...
    public function trend_analytic()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            if (!empty($result)) {
                ...
                $data['title'] = "DOCTOR CATEGORY ANALYSIS DASHBOARD - $title_category";
            } else {
                // If no result found, fallback to default title
                $data['title'] = 'DOCTOR CATEGORY ANALYSIS DASHBOARD';
            }

            #------------------------------#
            $data['content'] = $this->load->view('doctormodules/trend_analytic', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function dep_tat_edit()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'DOCTOR-Manage Turn Around Time';

            #------------------------------#

            $data['content'] = $this->load->view('doctormodules/dep_tat_edit', $data, true);
    ...
    public function feedback_dashboard()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- FEEDBACKS DASHBOARD';
            #------------------------------#
            $data['content'] = $this->load->view('doctormodules/feedback_dashboard', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function ticket_dashboard()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- TICKETS DASHBOARD';
            #------------------------------#
            $data['content'] = $this->load->view('doctormodules/ticket_dashboard', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_page()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- NPS ANALYSIS';
            #------------------------------#
            $data['content'] = $this->load->view('doctormodules/nps_page', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_promoter_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- NPS PROMOTERS LIST';
            $data['content'] = $this->load->view('doctormodules/nps_promoter_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_detractors_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- NPS DETRACTORS LIST';

            $data['content'] = $this->load->view('doctormodules/nps_detractors_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function nps_passive_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- NPS PASSIVES LIST';

            $data['content'] = $this->load->view('doctormodules/nps_passive_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function psat_satisfied_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- SATISFIED FEEDBACKS LIST';
            $data['content'] = $this->load->view('doctormodules/psat_satisfied_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function psat_unsatisfied_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- UNSATISFIED FEEDBACKS LIST';
            $data['content'] = $this->load->view('doctormodules/psat_unsatisfied_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function psat_page()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- DSAT ANALYSIS';
            #------------------------------#
            $data['content'] = $this->load->view('doctormodules/psat_page', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function department_tickets()
    {
        ...
        if ($this->session->userdata('isLogIn') == false)
            redirect('login');
        if (ismodule_active('DOCTOR') === true && isfeature_active('DEPARTMENT-HEAD-OVERALL-PAGE') === true) {

            $data['title'] = 'OT DOCTOR- TICKETS DASHBOARD';
            $data['content'] = $this->load->view('doctormodules/department_tickets', $data, true);
            $this->load->view('layout/main_wrapper', $data);
    ...
    public function admin_track()
    {
        ...
        $data['title'] = 'OT DOCTOR- TICKET DETAILS';
        $data['departments'] = $this->ticketsdoctor_model->read_by_id($this->uri->segment(3));
        $data['content'] = $this->load->view('doctormodules/ticket_track', $data, true);
        $this->load->view('layout/main_wrapper', $data);
    }
    ...
    public function alltickets()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- ALL TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->ticketsdoctor_model->alltickets();

            if (isfeature_active('DOCTOR-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('doctormodules/alltickets', $data, true);
            } else {
                $data['content'] = $this->load->view('doctormodules/dephead/alltickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
    ...
    public function addressedtickets()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- ADDRESSED TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->ticketsdoctor_model->addressedtickets();

            if (isfeature_active('DOCTOR-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('doctormodules/addressedtickets', $data, true);
            } else {
                $data['content'] = $this->load->view('doctormodules/dephead/addressedtickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
    ...
    public function track()
    {
        ...
        if (isfeature_active('DOCTOR-FEEDBACKS-DASHBOARD') === true) {
            ...
            $data['content'] = $this->load->view('doctormodules/dephead/ticket_track', $data, true);
        }
        $this->load->view('layout/main_wrapper', $data);
    }
    ...
    public function opentickets()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- OPEN TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->ticketsdoctor_model->read();

            if (isfeature_active('DOCTOR-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('doctormodules/opentickets', $data, true);
            } else {
                $data['content'] = $this->load->view('doctormodules/dephead/opentickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
            $this->session->set_userdata('referred_from', NULL);
        } else {
    ...
    public function closedtickets()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- CLOSED TICKETS';
            $dates = get_from_to_date();
            $data['departments'] = $this->ticketsdoctor_model->read_close();

            if (isfeature_active('DOCTOR-FEEDBACKS-DASHBOARD') === true) {
                $data['content'] = $this->load->view('doctormodules/closedtickets', $data, true);
            } else {
                $data['content'] = $this->load->view('doctormodules/dephead/closedtickets', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
    ...
    public function capa_report()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- CAPA REPORT';
            $dates = get_from_to_date();
            $data['departments'] = $this->ticketsdoctor_model->read_close();

            $data['content'] = $this->load->view('doctormodules/capa_report', $data, true);
            $this->load->view('layout/main_wrapper', $data);
    ...
    public function feedbacks_report()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- ALL FEEDBACKS REPORT';
            $data['content']  = $this->load->view('doctormodules/feedbacks_report', $data, true);
            $this->load->view('layout/main_wrapper', $data);
    ...
    public function feedbacks_report_login_apk()
    {
        ...
        $data['content']  = $this->load->view('doctormodules/op_feedbacks_report_login_apk', $data, true);
        $this->load->view('layout/main_wrapper', $data);
        // redirect('report/feedbacks_report');
    ...
    public function comments()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR COMMENTS LIST';
            $data['content'] = $this->load->view('doctormodules/recent_comments', $data, true);
            $this->load->view('layout/main_wrapper', $data);
    ...
    public function patient_feedback()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTORS FEEDBACK';
            #------------------------------#
            if (isfeature_active('DOCTOR-FEEDBACKS-DASHBOARD') === true) {

                $data['content'] = $this->load->view('doctormodules/patient_feedback', $data, true);
            } else {
                $data['content'] = $this->load->view('doctormodules/dephead/patient_feedback', $data, true);
            }
            $this->load->view('layout/main_wrapper', $data);
    ...
    public function notifications()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- FEEDBACK NOTIFICATIONS';
            $data['content'] = $this->load->view('doctormodules/notifications_list', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function downloadcomments()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $fileName = 'EF- DOCTOR COMMENTS - ' . $tdate . ' to ' . $fdate . '.csv';
    ...
    public function overall_excel_report()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $addressed = 'Addressed';
            $type = 'doctor';
            $op_feedbacks_count = $this->doctorsfeedback_model->patient_and_feedback($table_patients, $table_feedback, $sorttime, $setup);

            $op_tickets_count = $this->ticketsdoctor_model->alltickets();
            $op_open_tickets = $this->ticketsdoctor_model->read();
            $op_closed_tickets = $this->ticketsdoctor_model->read_close();
            $op_addressed_tickets = $this->ticketsdoctor_model->addressedtickets();

            $op_feedbacks_count = $this->doctorsfeedback_model->patient_and_feedback($table_patients, $table_feedback, $sorttime, $setup);


            $op_nps = $this->doctorsfeedback_model->nps_analytics($table_feedback, $asc, $setup);
            $op_psat = $this->doctorsfeedback_model->psat_analytics($table_patients, $table_feedback, $table_tickets, $sorttime);
            ...
            $dataexport[$i]['row1'] = 'OT DOCTOR FEEDBACK OVERALL REPORT';
            $dataexport[$i]['row2'] = '';
            $dataexport[$i]['row3'] = '';
            $dataexport[$i]['row4'] = '';
            $i++;
            ...
            ob_end_clean();
            $fileName = 'EF - OVERALL OT DOCTOR FEEDBACKS REPORT  - ' . $tdate . ' to ' . $fdate . '.csv';
            header('Pragma: public');
            header('Expires: 0');
            header('Cache-Control: must-revalidate, post-check=0, pre-check=0');
            header('Cache-Control: private', false);
    ...
    public function overall_patient_excel()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $header[2] = 'Asisstant Surgeon';
            $header[3] = 'Scrub Nurse';
            $header[4] = 'Surgery Name';
            $header[5] = 'Speciality';
            $header[6] = 'OT Room No';
            $header[7] = 'Surgery Start Date & Time';
            $header[8] = 'Surgery End Date & Time';
            ...
            foreach ($feedbacktaken as $row) {
                ...
                $dataexport[$i]['date'] = date('d-m-Y', strtotime($row->datetime));
                $dataexport[$i]['name'] = $data['name'];
                $dataexport[$i]['asistant_surgeon'] = $data['asistant_surgeon'];
                $dataexport[$i]['scrub_nurse'] = $data['scrub_nurse'];
                $dataexport[$i]['surgery_name'] = $data['surgery_name'];
                $dataexport[$i]['ward'] = $data['ward'];
                $dataexport[$i]['ot_num'] = $data['ot_num'];
                $dataexport[$i]['surgeryStartDate'] = date('d-m-Y H:i', strtotime($data->surgeryStartDate));
                $dataexport[$i]['surgeryEndDate'] = date('d-m-Y H:i', strtotime($data->surgeryEndDate));
            ...
            $tdate = $_SESSION['to_date'];
            ob_end_clean();
            $fileName = 'EF- OT DOCTOR WISE FEEDBACK REPORT - ' . $tdate . ' to ' . $fdate . '.csv';
            header('Pragma: public');
            header('Expires: 0');
            header('Cache-Control: must-revalidate, post-check=0, pre-check=0');
            header('Cache-Control: private', false);
    ...
    public function download_promoter_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $ip_nps = $this->doctorsfeedback_model->nps_analytics($table_feedback, $desc, $setup);
    ...
    public function download_satisfied_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $ip_psat = $this->doctorsfeedback_model->psat_analytics($table_patients, $table_feedback, $table_tickets, $desc);
    ...
    public function overall_department_excel()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $tdate = $_SESSION['to_date'];
            ob_end_clean();
            $fileName = 'EF- OT DOCTOR DEPARTMENT WISE TICKET REPORT - ' . $tdate . ' to ' . $fdate . '.csv';
            header('Pragma: public');
            header('Expires: 0');
            header('Cache-Control: must-revalidate, post-check=0, pre-check=0');
            header('Cache-Control: private', false);
    ...
    public function download_unsatisfied_list()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $rresult = $this->doctorsfeedback_model->setup_sub_result($setup);
    ...
    public function overall_pdf_report()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $fdate = $_SESSION['from_date'];
            $tdate = $_SESSION['to_date'];
            redirect('pdfreport/doctor_pdf_report?fdate=' . $tdate . '&tdate=' . $fdate);
    ...
    public function download_capa_report()
    {
        if (ismodule_active('DOCTOR') === true) {
            ...
            $departments = $this->ticketsdoctor_model->read_close();
            ...
            if (!empty($departments)) {
                ...
                foreach ($departments as $department) {
                    ...
                    if ($department->status == 'Closed') {
                        ...
                        $dataexport[$i]['row4'] = $department->feed->name . '(' . $department->feed->ot_num . ')';
                        if ($issue) {
            ...
            $fileName = 'EF- OT DOCTOR CAPA REPORT - ' . $tdate . ' to ' . $fdate . '.csv';
    ...
    public function download_alltickets()
    {
        if (ismodule_active('DOCTOR') === true) {
            ...
            if ($LOAD == 'outpatient_modules') {
                ...
                $dataexport = array();
                $i = 0;
                $departments = $this->ticketsdoctor_model->alltickets();
                $dataexport[$i]['row1'] = 'SL No.';
                $dataexport[$i]['row2'] = 'TICKET ID';
                $dataexport[$i]['row3'] = 'CREATED ON';
                $dataexport[$i]['row4'] = 'DOCTOR NAME';
                $dataexport[$i]['row5'] = 'SURGERY NAME';
                $dataexport[$i]['row6'] = 'OT NUMBER';
                    ...
                    foreach ($departments as $department) {
                        ...
                        foreach ($department->feed->reason as $key => $value) {
                            ...
                            if (!empty($department)) {
                                ...
                                $dataexport[$i]['row5'] = $department->feed->surgery_name;
                                $dataexport[$i]['row6'] = $department->feed->ot_num;
                ...
                $fileName = 'EF- OT DOCTOR ALL TICKETS REPORT - ' . $tdate . ' to ' . $fdate . '.csv';
    ...
    public function download_opentickets()
    {
        if (ismodule_active('DOCTOR') === true) {
            ...
            if ($LOAD == 'outpatient_modules') {
                ...
                $fileName = 'EF- OT DOCTOR OPEN TICKETS REPORT - ' . $tdate . ' to ' . $fdate . '.csv';
    ...
    public function ticket_resolution_rate()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- TICKET RESOLUTION RATE';
            #------------------------------#
            $data['content'] = $this->load->view('doctormodules/ticket_analisys_page', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
            redirect('dashboard/noaccess');
        }
    ...
    public function average_resolution_time()
    {
        ...
        if (ismodule_active('DOCTOR') === true) {
            ...
            $data['title'] = 'OT DOCTOR- AVERAGE RESOLUTION TIME';
            #------------------------------#
            $data['content'] = $this->load->view('doctormodules/ticket_analisys_page', $data, true);
            $this->load->view('layout/main_wrapper', $data);
        } else {
