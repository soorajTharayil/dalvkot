...
class Analytics_esr extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table_feedback = 'bf_feedback_esr';
        $this->table_patients = 'bf_employees_esr';
        $this->sorttime = 'asc';
        $this->setup = 'setup_esr';
        $this->asc = 'asc';
        $this->desc = 'desc';
        $this->table_tickets = 'tickets_esr';
        $this->open = 'Open';
        $this->closed = 'Closed';
    ...
    public function tickets_recived_by_department()
    {
       // $dates = get_from_to_date();
        ...
        $department = $this->isr_model->get_departmentint($this->type);

        $all_tickes = $this->isr_model->get_tickets($this->table_feedback, $this->table_tickets);
        $report = array();
        $response = array();
