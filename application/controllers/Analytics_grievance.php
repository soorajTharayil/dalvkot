...
class Analytics_grievance extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->table_feedback = 'bf_feedback_grievance';
        $this->table_patients = 'bf_employees_grievance';
        $this->sorttime = 'asc';
        $this->setup = 'setup_grievance';
        $this->asc = 'asc';
        $this->desc = 'desc';
        $this->table_tickets = 'tickets_grievance';
        $this->open = 'Open';
        $this->closed = 'Closed';
    ...
    public function tickets_recived_by_department()
    {
       // $dates = get_from_to_date();
        ...
        $department = $this->grievance_model->get_departmentint($this->type);

        $all_tickes = $this->grievance_model->get_tickets($this->table_feedback, $this->table_tickets);
        $report = array();
        $response = array();
