...
class Doctorsopdfeedback_model extends CI_Model
{
	...
	public function get_feedback_rows() {
		...
		$this->db->select('*');
		$this->db->from('bf_feedback_doctors_opd');
...
//keep
	...
	public function reason_to_choose_hospital($table_feedback, $sorttime)
	{
		...
		$i = 0;
		$piechart = array();
		$choice_array = array('location' => 'Quality patient care', 'specificservice' => 'Advanced technology', 'referred' => 'Efficient support staff', 'friend' => 'Collaborative environment', 'previous' => 'Well-maintained facilities', 'docAvailability' => 'Strong leadership', 'companyRecommend' => 'Professional development', 'otherReason' => 'Good communication');
		$tcount = 0;
