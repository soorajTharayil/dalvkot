        ...
        <div class="col-sm-12">
            <div class="panel panel-default thumbnail">
                ...
                <div class="panel-heading no-print">
                    <div class="btn-group">
                        <a class="btn btn-primary" href="<?php echo base_url("department") ?>"> <i
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <input name="description" type="text" class="form-control" id="name"
                                        placeholder="Department" value="<?php echo $department->description ?>"
                                        readonly>
                                </div>
                            </div>
                            <div class="form-group row" style="display:none;">
                                <label for="name" class="col-xs-3 col-form-label">Department Parameter <i
                                        class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="name" type="text" class="form-control" id="name"
                                        placeholder="<?php echo display('department_name') ?>"
                                        value="<?php echo $department->name ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name" class="col-xs-3 col-form-label">Department HOD <i
                                        class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="pname" type="text" class="form-control" id="name"
                                        placeholder="<?php echo display('pname') ?>"
                                        value="<?php echo $department->pname ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name" class="col-xs-3 col-form-label">Mobile <i
                                        class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="mobile" type="text" class="form-control" id="name" placeholder=""
                                        value="<?php echo $department->mobile ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="name" class="col-xs-3 col-form-label">Email <i
                                        class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="email" type="email" class="form-control" id="name"
                                        value="<?php echo $department->email ?>">
                                </div>
                            </div>
                            <div class="form-group row" id="show_hide_password">
                                <label for="name" class="col-xs-3 col-form-label">Password <i
                                        class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="password" type="password" class="form-control" id="name"
                                        value="<?php echo $department->password ?>">
