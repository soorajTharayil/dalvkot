...
$feedbacktaken = $this->doctorsopdfeedback_model->patient_and_feedback($table_patients, $table_feedback, $sorttime, $setup);
...
$ip_tickets_count = $this->ticketsopddoctor_model->alltickets();
$ip_open_tickets = $this->ticketsopddoctor_model->read();
$ip_closed_tickets = $this->ticketsopddoctor_model->read_close();
$ip_addressed_tickets = $this->ticketsopddoctor_model->addressedtickets();
...
$ticket = $this->doctorsopdfeedback_model->get_tickets($table_feedback, $table_tickets);
...
$pdf->SetTitle('OPD - OVERALL DOCTORS FEEDBACK REPORT  - ' . $d1 . ' to ' . $d2 . '  ');
$pdf->SetSubject('OPD - OVERALL DOCTORS FEEDBACK REPORT  - ' . $d1 . ' to ' . $d2 . '  ');
...
$html .= '<h2 style="text-align:center;">VYKO OPD DOCTOR FEEDBACK REPORT </h2>';
...
$pdf->Output('OPD - OVERALL DOCTORS FEEDBACK REPORT  - ' . $d1 . ' to ' . $d2 . ' .pdf', 'I');
