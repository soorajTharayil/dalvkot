    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("patientop") ?>"> <i class="fa fa-list"></i>
                    ...
                    <div class="col-md-8 col-sm-12 col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input name="name" type="text" class="form-control" id="name"
                                    oninput="restrictToAlphabets(event)" maxlength="20" placeholder="Patients Name"
                        ...
                        <div class="form-group row">
                            <label for="firstname"
                                ...
                                <i class="text-danger">*</i></label>
                            <div class="col-xs-9">
                                <input name="patient_id" type="text" class="form-control" maxlength="20" id="patient_id"
                                    placeholder="Patients ID" value="<?php echo $patient->patient_id ?>" <?php if ($patient->id) {
                                           echo 'readonly';
                                       } ?> required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                ...
                                <small class="text-danger" id="mobile-error" style="display: none;">Mobile number must
                        ...
                        <div class="form-group row">
                            <label for="firstname"
                                class="col-xs-3 col-form-label"><?php echo lang_loader('global', 'global_ward'); ?> <i
                                    class="text-danger">*</i></label>
                            <div class="col-xs-9">
                                <select name="ward" class="form-control" onchange="get_bed_no(this.value)" required>
                                    <option value="" selected><?php echo lang_loader('global', 'global_select_ward'); ?>
                                    </option>
