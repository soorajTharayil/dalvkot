<!-- This page is used to show Discharged Patients -->
<div class="content">
    <div class="row">
        <!--  table area start-->
        <div class="col-lg-12">
                    ...
                    <table width="100%" class="datatableip table table-striped table-bordered table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang_loader('global','global_gender'); ?></th>
                                <th><?php echo lang_loader('global','global_age'); ?></th>
                                <th><?php echo lang_loader('global','global_admitted_date'); ?></th>
                            ...
                            <?php if (!empty($patients) && $patient->created_by != null) { ?>
                                ...
                                <?php foreach ($patients as $patient) { ?>
                                    <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
                                        ...
                                        <td class="center">
                                            <!-- <a href="<?php echo base_url("patientop/profile/$patient->id") ?>" class="btn btn-xs btn-success"><i class="fa fa-eye"></i></a> -->
                                            <a href="<?php echo base_url("patientop/edit/$patient->id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-edit"></i></a>

                                            <!-- <a href="<?php echo base_url("case_manager/patientop/form?pid=$patient->patient_id") ?>" class="btn btn-xs btn-warning" title="Add to Case Manager"><i class="fa fa-plus"></i></a> -->

                                            <!-- <a href="<?php echo base_url("patientop/delete/$patient->id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a> -->
                                        </td>
