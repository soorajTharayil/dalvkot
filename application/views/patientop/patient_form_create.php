                        ...
                        <div class="panel panel-bd">
                            <div class="panel-body" style="height: 100px;">
                                <div class="statistic-box">
                                    ...
                                    <div class="small">Total Outpatients</div>
                                    <div class="icon">
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-body" style="height: 100px;">
                                    <div class="statistic-box">
                                        ...
                                        <div class="small">Active Outpatients</div>
                                        <div class="icon">
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-body" style="height: 100px;">
                                    <div class="statistic-box">
                                        ...
                                        <div class="small">Former Outpatients</div>
                                        <div class="icon">
                                ...
                                <div class="col-xs-9">
                                    <select name="ward" class="form-control" onchange="get_bed_no(this.value)" required>
                                        <option value="" selected>
                                            <?php echo lang_loader('global', 'global_select_ward'); ?>
                                        </option>
                                ...
                                <div class="col-sm-offset-3 col-sm-6">
                                    <div class="ui buttons">
                                        ...
                                        <button class="ui positive button"
                                            id="submitdata"><?php echo 'Save'; ?></button>
                                    </div>
                                </div>
                            </div>
                            <?php echo form_close() ?>
