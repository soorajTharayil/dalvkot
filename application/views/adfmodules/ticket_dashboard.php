						...
						<div class="panel-body" style="height: 150px; display:inline;">
							<div class="alert alert-warning ">
								...
								<span style="font-size: 15px">
									<?php echo lang_loader('adf', 'adf_you_have_received_most_complaints_in'); ?> <strong><?php echo $highest_complain; ?></strong>
								</span>
							</div>
							<div class="alert alert-success">
								<span style="font-size: 15px">
									<?php echo lang_loader('adf', 'adf_you_have_received_least_complaints_in'); ?> <strong><?php echo $lowest_complain; ?></strong>
								</span>
							</div>
						</div>
					</div>
							...
							<a href="<?php echo base_url($this->uri->segment(1)); ?>/track/<?php echo $ticketdata->id ?>">
								<div class="inbox-item">
									<p class="inbox-item-author">
										<?php echo lang_loader('adf', 'adf_adft'); ?> <?php echo $ticketdata->id; ?>
