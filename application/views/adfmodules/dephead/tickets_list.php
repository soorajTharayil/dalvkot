<div class="content">
	<div class="row">
		...
		$ip_link_patient_feedback = base_url('admissionfeedback/patient_feedback?id=');
				...
				<div class="panel-body" style="background: #fff;">
					...
					<div class="patient-card">
						<h4 class="patient-info">
							<strong><?php echo lang_loader('adf','adf_patient_details'); ?></strong>
						</h4>
					...
					<table class="<?php if ($this->session->userdata('isLogIn') === true) {
						...
						<thead>
							<tr>
								...
								<th style="white-space: nowrap;"><?php echo lang_loader('adf','adf_reasons'); ?></th>
								<?php if ($this->session->userdata('user_role') != 4) { ?>
									<th><?php echo lang_loader('adf','adf_department'); ?></th>
								<?php } ?>
								<th style="white-space: nowrap;"><?php echo lang_loader('adf','adf_created_on'); ?></th>
								<th style="white-space: nowrap;"><?php echo lang_loader('adf','adf_modified_on'); ?></th>
						...
						<?php foreach ($departments as $department) { ?>
							...
							<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
								...
								<td style="align-items: center;">
									<a href="<?php echo base_url("admissionfeedback/admin_track/$department->id") ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $tool; ?>" class="btn btn-sm btn-block btn-<?php echo $color; ?>"><?php echo $department->status; ?> <i style="font-size:x-small;" class="fa fa-edit"></i></a>
								</td>
							</tr>
						<?php } ?>
					</table>
