		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" data-placement="bottom" data-toggle="tooltip" title="Download open tickets report" href="<?php echo base_url($this->uri->segment(1)) . '/download_' . ($this->uri->segment(2)) ?>">
						...
						<table class="ipticketsopen table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<?php if (ismodule_active('adf_tat') === true) { ?>
								...
								?>
									...
									?>
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
											...
											<?php if (adf_tat('open_ticket') === true) { ?>
												<td style="overflow: clip; word-break: break-all;">
													<?php
