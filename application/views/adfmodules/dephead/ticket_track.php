            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        <tr>
                            <td><strong><?php echo lang_loader('adf', 'adf_patient_details'); ?>
                                </strong></td>
                            <td>
                        ...
                        <tr>
                            <td> <strong><?php echo lang_loader('adf', 'adf_ticket_deatails'); ?></strong> </td>
                            <td><?php echo lang_loader('adf', 'adf_rated'); ?><strong><?php echo $department->ratingt; ?></strong>
                                <?php echo 'for '; ?>
                        ...
                        <?php if ($department->department->pname) { ?>
                            <tr>
                                <td><strong><?php echo lang_loader('adf', 'adf_assigned_to'); ?></strong></td>
                                <td><?php echo $department->department->pname; ?></td>
                            </tr>
                        <?php } ?>
                        <tr>
                            <td><strong><?php echo lang_loader('adf', 'adf_created_on'); ?></strong></td>
            ...
            <?php if ($open == true) { ?>
                <?php if (($department->status != 'Closed')) { ?>
                    ...
                    <div class="col-sm-12" id="capa" style="overflow:auto;">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3><?php echo lang_loader('adf', 'adf_capa_close_ticket'); ?></h3>
                            </div>
                            <?php echo form_open('ticketsadf/create', 'class="form-inner"') ?>
                            <?php echo form_hidden('id', $department->id) ?>
                            <div class="col-sm-12" style="overflow:auto;">
                    ...
                    <div class="col-sm-12" id="move" style="overflow:auto;">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3><?php echo lang_loader('adf', 'adf_transfering_ticket_department'); ?></h3>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <br />
                                <?php echo form_open('ticketsadf/create', 'class="form-inner"') ?>
