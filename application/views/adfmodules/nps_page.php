			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" title="<?php echo $nps_info_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('adf','adf_nps'); ?></div>
						<div class="icon">
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" title="<?php echo $promoter_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('adf','adf_promoters'); ?></div>
						<div class="icon">
							<i class="fa fa-smile-o"></i>
						</div>
						<a href="<?php echo $ip_link_promoter_list; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('adf','adf_view_list'); ?></a>
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" title="<?php echo $detractor_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('adf','adf_detractors'); ?></div>
						<div class="icon">
							<i class="fa fa-frown-o"></i>
						</div>
						<a href="<?php echo $ip_link_detractor_list; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('adf','adf_view_list'); ?></a>
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" title="<?php echo $passive_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('adf','adf_passives'); ?> </div>
						<div class="icon">
							<i class="fa fa-meh-o"></i>

						</div>
						<a href="<?php echo $ip_link_passives_list; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('adf','adf_view_list'); ?></a>
