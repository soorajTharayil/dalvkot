...
$ip_tickets_count = $this->admissionfeedback_model->feedback_and_ticket($table_feedback, $table_tickets, $sorttime);
// tooltips
$ip_open_tickets = $this->admissionfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $open);
$ip_reopen_tickets = $this->admissionfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $reopen);

$ip_closed_tickets = $this->admissionfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $closed);
$ip_addressed_tickets = $this->admissionfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $addressed);
...
$ticket_analisys = $this->admissionfeedback_model->tickets_recived_by_department($type, $table_feedback, $table_tickets);
...
$selectionarray = $this->admissionfeedback_model->reason_to_choose_hospital($table_feedback, $sorttime);
// $close_rate = $this->admissionfeedback_model->ticket_rate($table_tickets, $table_ticket_action, $closed);
// $close_time = $this->admissionfeedback_model->convertSecondsToTime($close_rate);
