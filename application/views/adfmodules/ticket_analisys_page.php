<div class="content">
	...
	$ip_psat = $this->admissionfeedback_model->psat_analytics($table_patients, $table_feedback, $table_tickets, $asc);
	?>
	<!-- Metric Boxes-->
	<div class="row">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<table class="adfticketanalisys table table-striped table-bordered table-hover" cellspacing="0" width="100%">
				<thead>
					<th><?php echo lang_loader('adf','adf_slno'); ?></th>
					<th><?php echo lang_loader('adf','adf_department'); ?></th>
					<!-- <th>Percentage</th> -->
					<th><?php echo lang_loader('adf','adf_s_total_tickets'); ?></th>
					<th><?php echo lang_loader('adf','adf_s_open_tickets'); ?></th>
					<!-- change here according to helper -->
					<?php if (ticket_addressal('adf_addressal') === true) { ?>
						<th><?php echo lang_loader('adf','adf_s_addressed_tickets'); ?></th>
					<?php } ?>
					<th><?php echo lang_loader('adf','adf_s_closed_tickets'); ?></th>
					<?php if ($this->uri->segment(2) == "ticket_resolution_rate") { ?>
						<th><?php echo lang_loader('adf','adf_resolution_rate'); ?></th>
					<?php } ?>
					<?php if ($this->uri->segment(2) == "average_resolution_time") { ?>
						<th><?php echo lang_loader('adf','adf_avg_resolution_time'); ?></th>
					<?php } ?>
				</thead>
				<?php $sl = 1;
				$i = 0; ?>
