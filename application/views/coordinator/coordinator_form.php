    ...
    <div class="col-sm-12">
        <div class="panel panel-default ">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("Coordinator") ?>"> <i class="fa fa-list"></i>
                        Coordinator List </a>
                </div>
            </div>
            ...
            <div class="panel-body panel-form">
                <div class="row">
                    <div class="col-md-9 col-sm-12">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-xs-3 col-form-label">Employee ID <i
                                    class="text-danger">*</i></label>
                            <div class="col-xs-9">
                                <input name="guid" type="text" class="form-control" id="name" placeholder="Employee ID"
                                    value="<?php echo $department->guid ?>" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input name="password" type="text" class="form-control" id="name" placeholder="Password"
                                    value="<?php echo $department->password ?>" requried>
                            </div>
                        </div>
