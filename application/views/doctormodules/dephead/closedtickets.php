							...
							<thead>
								<tr>
									...
									<?php if (op_tat('close_ticket') === true) { ?>
										<th style="white-space: nowrap;"><?php echo lang_loader('op','op_tat'); ?></th>
									<?php } ?>
								...
								<?php if (!empty($departments)) {		?>
									...
									<?php foreach ($departments as $department) {
										...
										if ($department->status == 'Closed') {
											...
											$query = $this->db->get('ticket_doctor_message');
											$ticket = $query->result();
									...
									?>
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
											...
											<td style="overflow: clip; word-break: break-all;"><?php echo $department->feed->name; ?>&nbsp;(<a href="<?php echo $ip_link_patient_feedback . $department->feedbackid; ?>"><?php echo $department->feed->ot_num; ?></a>)
												<br>
