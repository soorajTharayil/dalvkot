			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<table class="opnpspromoters table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								...
								<th><?php echo lang_loader('op','op_nps'); ?><br><?php echo lang_loader('op','op_nps_score_9_10'); ?></th>
