			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table class="opnpsdetractor table table-striped table-bordered table-hover" cellspacing="0" width="100%">
						<thead>
								...
								<th><?php echo lang_loader('op','op_nps'); ?><br><?php echo lang_loader('op','op_nps_score_0_6'); ?></th>
								<?php if (nps_detractors_page('avg_rating') == true) { ?>
									<th><?php echo lang_loader('op','op_average'); ?><br><?php echo lang_loader('op','op_rating'); ?></th>
								<?php } ?>

								<?php if (nps_detractors_page('nps_comment') == true) { ?>
									<th><?php echo lang_loader('op','op_nps'); ?><br> <?php echo lang_loader('op','op_comment'); ?></th>
								<?php } ?>
								
								<?php if (nps_detractors_page('overall_comments') == true) { ?>
							...
							<tbody>
								<?php foreach ($feedback as $detractor) { ?>
									...
									<tr>
										...
										<?php if (nps_detractors_page('nps_comment') == true) { ?>
											<td style="overflow: clip; word-break: break-all;">
												<?php echo ($detractor->detractorcomment); ?>
											</td>
										<?php } ?>
