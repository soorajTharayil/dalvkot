<div class="content">
	<div class="row">
		...
		$ip_link_patient_feedback = base_url('doctor/patient_feedback?id=');
				...
				<div class="panel-body" style="background: #fff;">
					...
					<div class="patient-card">
						<h4 class="patient-info">
							<strong><?php echo lang_loader('op','op_patient_details'); ?></strong>
						</h4>
					...
					<table class="<?php if ($this->session->userdata('isLogIn') === true) {
						...
						<thead>
							<tr>
								...
								<th style="white-space: nowrap;"><?php echo lang_loader('op','op_reasons'); ?></th>
						...
						<?php foreach ($departments as $department) { ?>
							...
							<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
								...
								<td style="align-items: center;">
									<a href="<?php echo base_url("doctor/admin_track/$department->id") ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $tool; ?>" class="btn btn-sm btn-block btn-<?php echo $color; ?>"><?php echo $department->status; ?> <i style="font-size:x-small;" class="fa fa-edit"></i></a>
								</td>
							</tr>
						<?php } ?>
					</table>
