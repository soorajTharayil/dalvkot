			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed doctor wise feedback report for OT." href="<?php echo base_url($this->uri->segment(1)) . '/overall_patient_excel' ?>">
									...
									<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC"
										...
										<td style="overflow: clip;">
											...
											<?php if (allfeedbacks_page('feedback_id') == false) { ?>
												(<a href="<?php echo  $ip_link_patient_feedback . $id; ?>"><?php echo $param->ot_num; ?></a>)
											<?php } else { ?>
