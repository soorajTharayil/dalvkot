 									...
 									<?php foreach ($departments as $department) {
										...
										?>
 										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltop" title="<?php echo $rowmessage; ?>">
 											...
 											<td style="overflow: clop; word-break: break-all;"><?php echo $department->feed->name; ?>&nbsp;(<a href="<?php echo $op_link_patient_feedback . $department->feedbackid; ?>"><?php echo $department->feed->ot_num; ?></a>)
 												<br>
