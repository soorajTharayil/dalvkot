...
//     }
// }
$allFeedback = $this->efeedor_model->get_feedback('bf_opatients', 'bf_feedback_doctors_opd', $fdate, $tdate);
$setup = $this->efeedor_model->setup_result('setup_doctor_opd');
        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body" style="height: 100px;">
                <div class="statistic-box">
                    ...
                    <div class="small"> Satisfied Feedbacks <a href="javascript:void()" data-toggle="tooltip" title="Doctors who rated above average and have no negative experiences in your category."><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
                    <div class="icon">
        ...
        <div class="panel panel-bd">
            ...
            <div class="panel-body" style="height: 100px;">
                <div class="statistic-box">
                    ...
                    <div class="small"> Unsatisfied Feedbacks <a href="javascript:void()" data-toggle="tooltip" title="Doctors who rated below average and have one or more negative experiences in your category."><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
                    <div class="icon">
