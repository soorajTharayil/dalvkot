...
$closed = 'Closed';
$addressed = 'Addressed';
$table_ticket_action = 'ticket_doctor_opd_message';
$type = 'doctoropd';
$department = 'department';
$reopen = 'Reopen';
/* END TABLES FROM DATABASE */

/* doctorsopdfeedback_model.php FOR GLOBAL UPDATES */
...
$ip_tickets_count = $this->doctorsopdfeedback_model->feedback_and_ticket($table_feedback, $table_tickets, $sorttime);
// tooltips
$ip_open_tickets = $this->doctorsopdfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $open);
$ip_reopen_tickets = $this->doctorsopdfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $reopen);

$ip_closed_tickets = $this->doctorsopdfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $closed);
$ip_addressed_tickets = $this->doctorsopdfeedback_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $addressed);
...
// $ip_department = $this->departmenthead_model->departmenthead_values($table_patients, $table_feedback, $table_tickets, $sorttime, $department, $setup, $type);
$ticket_analisys = $this->doctorsopdfeedback_model->tickets_recived_by_department($type, $table_feedback, $table_tickets);
...
$ip_psat = $this->doctorsopdfeedback_model->psat_analytics($table_patients, $table_feedback, $table_tickets, $sorttime);
...
$close_rate = $this->doctorsopdfeedback_model->ticket_rate($table_tickets, $status, $table_feedback, $table_ticket_action);
$ticket_close_rate = secondsToTime($close_rate);

$ip_satisfied_count = $this->doctorsopdfeedback_model->get_satisfied_count($table_feedback, $table_tickets);
$ip_unsatisfied_count = $this->doctorsopdfeedback_model->get_unsatisfied_count($table_feedback, $table_tickets);

// Key Highlights
$key_highlights = $this->doctorsopdfeedback_model->key_highlights($table_patients, $table_feedback, $sorttime, $setup);


$selectionarray = $this->doctorsopdfeedback_model->reason_to_choose_hospital($table_feedback, $sorttime);
// $close_rate = $this->doctorsopdfeedback_model->ticket_rate($table_tickets, $table_ticket_action, $closed);
// $close_time = $this->doctorsopdfeedback_model->convertSecondsToTime($close_rate);
