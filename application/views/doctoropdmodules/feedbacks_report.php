			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip" title="Download detailed doctor wise feedback report for OPD." href="<?php echo base_url($this->uri->segment(1)) . '/overall_patient_excel' ?>">
