                    ...
                    <table class=" table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang_loader('pcf', 'dept_level_escalation'); ?></th>
                                <th><?php echo lang_loader('pcf', 'pcf_tat_l2_escalation'); ?></th>
                                <th><?php echo lang_loader('pcf', 'pcf_tat_l3_escalation'); ?></th>
                            </tr>
                        </thead>
                        <!-- table head end -->
