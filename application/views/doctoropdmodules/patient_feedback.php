<div class="content">
	...
	if ($this->input->post('id') || $this->input->get('id')) {
		...
		$this->db->where('id', $id);
		$query = $this->db->get('bf_feedback_doctors_opd');
					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="OPD DOCTOR FEEDBACKS- <Feedback ID>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> ODF <?php echo $result->id; ?> </h3>
							</div>
							<div class="panel-body" style="background: #fff;">
								...
								if ($this->session->user_role == 4) {
									...
									$this->db->where('setup_doctor_opd.parent', 1);
									...
									$sresult = $this->doctorsopdfeedback_model->setup_result('setup_doctor_opd');
								}
