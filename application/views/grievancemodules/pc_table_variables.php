...
$int_tickets_count = $this->grievance_model->feedback_and_ticket($table_feedback, $table_tickets, $sorttime);
// // tooltips
$int_open_tickets = $this->grievance_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $open);
$int_reopen_tickets = $this->grievance_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $reopen);

$int_closed_tickets = $this->grievance_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $closed);
$int_addressed_tickets = $this->grievance_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $addressed);
...
$ticket_analisys = $this->grievance_model->tickets_recived_by_department_interim($type, $table_feedback, $table_tickets);
// // IP ANALYTICS
// $int_nps = $this->grievance_model->nps_analytics($table_feedback, $asc, $setup);
// $int_nps_tool = 'Promoters: ' . ($int_nps['promoters_count']) . ', ' . "Detractors: " . ($int_nps['detractors_count']) . ', ' . "Passives: " . ($int_nps['passives_count']);
// $int_psat = $this->grievance_model->psat_analytics($table_patients, $table_feedback, $table_tickets, $sorttime);
...
// $int_satisfied_count = $this->grievance_model->get_satisfied_count($table_feedback, $table_tickets);
// $int_unsatisfied_count = $this->grievance_model->get_unsatisfied_count($table_feedback, $table_tickets);

// // Key Highlights
// $key_highlights = $this->grievance_model->key_highlights($table_feedback, $asc, $setup);
