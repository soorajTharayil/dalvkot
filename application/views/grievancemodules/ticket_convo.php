<div class="col-lg-12">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			...
			<h3><?php echo lang_loader('sg','sg_grievance_history'); ?></h3>
		...
		<div class="panel-body" style="    height: auto;     overflow: auto;">
			...
			<div class="message_inner">
						...
						<a href="javascript:return false;">
							<div class="inbox-item">
								...
								<p class="inbox-item-text" style="overflow: clip; word-break: break-all;">
									<b><?php echo lang_loader('sg','sg_action'); ?></b>:
				...
				<?php if ($nodata == true) { ?>
					<h3 style="text-align: center; color:tomato;"><?php echo lang_loader('sg','sg_ticket_is_open'); ?></h3>
				<?php  }
				?>
