			...
			<div class="col-lg-12">
				<div class="panel panel-default ">
					...
					<?php   if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) { ?>
						...
						<table class="grievancecapa table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th><?php echo lang_loader('sg','sg_slno'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('sg','sg_sg'); ?></th>
