		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('sg','sg_download_addressed_grievance_report_tooltip'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/download_opentickets' ; ?>">
					...
					<?php   if (isfeature_active('IP-FEEDBACKS-DASHBOARD') === true) { ?>
						...
						<table class="grievanceticketsaddressed table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<?php } ?>
									<th style="white-space: nowrap;"><?php echo lang_loader('sg','sg_addressal_comment'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('sg','sg_modified_on'); ?></th>
