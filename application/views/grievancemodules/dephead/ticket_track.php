                ...
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="GRIEVANCE- <GRIEVANCE ID> ">
                            <i class="fa fa-question-circle"
                                aria-hidden="true"></i></a>&nbsp;SG-<?php echo $department->id; ?></h3>
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        ...
                        if ($param['image'] != '' && $param['image'] != NULL) {
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo $encodedImage; ?>" width="100%" height="300px" alt="Rendered Image"
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group row">
                                        <textarea class="form-control" minlength="25" rows="5" id="comment" name="reply"
                                            placeholder="Reason to reopen grievance" required></textarea>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-offset-3 col-sm-6">
                                        <div class="ui buttons"> <button
                                                class="ui positive button"><?php echo lang_loader('sg', 'sg_submit'); ?></button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-9">
                                        <div class="form-check">
                                            ...
                                            <label class="radio-inline"><input type="radio" name="status" value="Closed"
                                                    onclick="showbox()"
                                                    checked="true"><?php echo lang_loader('sg', 'sg_close'); ?></label>
                                        </div>
                                    </div>
                                </div>
                                <br>
                    ...
                    <div class="col-sm-12" id="move" style="overflow:auto;">
                        <div class="panel panel-default">
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group row">
                                    <label for="name"
                                        class="col-xs-3 col-form-label"><?php echo lang_loader('sg', 'sg_category'); ?></label>
                                    <div class="col-xs-9">
                                ...
                                <div class="form-group row">
                                    <label for="name"
                                        class="col-xs-3 col-form-label"><?php echo lang_loader('sg', 'sg_comment'); ?></label>
                                    <div class="col-xs-9">
                                        <textarea class="form-control" rows="5" minlength="25" id="comment" name="reply"
                                            placeholder="Enter the reason for grievance transfer" required></textarea>
                                        <input type="hidden" name="reply_by" value="Admin">
