						...
						?>
							...
							<a href="javascript:return false;">
								<div class="inbox-item">
									<strong class="inbox-item-author"><?php echo $param->name; ?> (<a href="<?php echo base_url('report/patient_complaint_details?patientid=' . $r->patientid); ?>"><?php echo $r->patientid; ?></a>) </strong>
