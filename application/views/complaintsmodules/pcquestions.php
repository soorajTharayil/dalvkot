	...
	<div class="row">
		...
		<div class="col-sm-12">
			...
			<div class="panel-heading no-print">
                    <div class="btn-group">
                  <a href="<?php echo base_url("question/add") ?>"> <button class="btn btn-success" > <i class="fa fa-plus"></i><?php echo lang_loader('pcf','pcf_add_question'); ?></button></a>  
                    </div>
                </div>
				<div class="panel-body">
					...
					<table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							...
							<th><?php echo lang_loader('pcf','pcf_title'); ?></th>
							<th><?php echo lang_loader('pcf','pcf_questions'); ?></th>
							<th><?php echo lang_loader('pcf','pcf_shortkey'); ?></th>
							<th><?php echo lang_loader('pcf','pcf_title_2l'); ?></th>
							<th><?php echo lang_loader('pcf','pcf_ques_2l'); ?></th>
							<th><?php echo lang_loader('pcf','pcf_title_3l'); ?></th>
							<th><?php echo lang_loader('pcf','pcf_lang_3l'); ?></th>
							<th><?php echo lang_loader('pcf','pcf_action'); ?></th>
