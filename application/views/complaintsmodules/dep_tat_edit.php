                    ...
                    <table class=" table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <thead >
                            <tr>
                                ...
                                <th style="vertical-align: middle;"><?php echo lang_loader('pcf', 'pcf_department'); ?></th>
                                <th style="vertical-align: middle;"><?php echo lang_loader('pcf', 'pcf_parameter'); ?></th>
                                <th style="vertical-align: middle;"><?php echo lang_loader('pcf', 'dept_level_escalation'); ?>
                                    <br><br>
                                ...
                                <th><?php echo lang_loader('pcf', 'pcf_tat_l2_escalation'); ?>
                                    <br><br>
                                    <div style="text-align: center;">
                                        Set Default Time
                                    </div>
                                ...
                                <th><?php echo lang_loader('pcf', 'pcf_tat_l3_escalation'); ?>
                                    <br><br>
                                    <div style="text-align: center;">
                                        Set Default Time
                                    </div>
