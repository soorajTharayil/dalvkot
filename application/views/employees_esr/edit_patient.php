    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-success" href="<?php echo base_url("employee") ?>"> <i class="fa fa-list"></i> <?php echo 'Employee List'; ?> </a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 col-lg-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input name="name" type="text" class="form-control" id="name" oninput="restrictToAlphabets(event)" maxlength="20" placeholder="Employee Name" value="<?php echo $patient->name ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input name="patient_id"  type="text" class="form-control" maxlength="20" id="patient_id" placeholder="Employee ID" value="<?php echo $patient->patient_id ?>" <?php if ($patient->id) {
                                                                                                                                                                                                    echo 'readonly';
                                                                                                                                                                                                } ?> required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-9">
                                <input type="number" name="mobile" class="form-control" id="mobile" pattern="[0-9]{10}" oninput="sanitizeInput(this)" maxlength="10" placeholder="Mobile Number" value="<?php echo $patient->mobile; ?>" required>
...
<!-- 
                        ...
                        <?php /*if ($patient->id != null) { ?>
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="discharged_date" class="datetimepicker form-control" type="text" placeholder="" id="discharged_date"  value="<?php echo date('d-m-Y H:i', strtotime($patient->discharged_date)); ?>" required>
                                </div>
                            </div>
                        <?php } */ ?>
...
<script>
    ...
    //     $.get("<?php //echo base_url(); 
                    ?>employee/get_bed_no?id=" + id + "&bid=" + bid, function(data, status) {
    //         $('#getbedno').html(data);
    //     });
    // }
