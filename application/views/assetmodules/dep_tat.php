...
<div class="content">
	...
	$this->db->select('*');
	$this->db->where('department.type','interim');
					...
					<table class="datatables table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<thead>
							<tr>
								...
								<th><?php echo lang_loader('pcf','pcf_issue'); ?></th>
								<th><?php echo lang_loader('pcf','pcf_tat_set'); ?></th>
							...
							<?php if (!empty($departments)) { ?>
								...
								<?php foreach ($departments as $department) { ?>
									...
									<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
										...
										$value2 = $this->pc_model->convertSecondsToTime($department->close_time);
										$dep_tat = '';
										if ($value2['days'] != 0) {
