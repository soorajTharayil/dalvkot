            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="text-align: right;">
                        <div class="btn-group">
                            <a class="btn btn-success" data-placement="bottom" style="margin-right: 10px;" data-toggle="tooltip" title="Register an asset" href="<?= base_url($this->uri . '/add_asset?user_id=' . $this->session->userdata['user_id']) ?>" target="_blank">
