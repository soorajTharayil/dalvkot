...
$int_feedbacks_count = $this->asset_model->patient_and_feedback($table_feedback, $sorttime);

// // To see the total tickets count
$int_tickets_count = $this->asset_model->feedback_and_ticket($table_feedback, $table_tickets, $sorttime);
// // tooltips
$int_open_tickets = $this->asset_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $open);
$int_reopen_tickets = $this->asset_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $reopen);

$int_closed_tickets = $this->asset_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $closed);
$int_addressed_tickets = $this->asset_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $addressed);
...
$asset_assign_tickets = $p - $un;

// Prepare the int_department array with relevant counts
$int_department['alltickets'] = $p;
$int_department['asset_use'] = $asset_use;
$int_department['asset_assign_tickets'] = $asset_assign_tickets;
//$int_department['asset_broken_tickets'] = $q;
$int_department['asset_repair_tickets'] = $r;
$int_department['asset_reassign_tickets'] = $d;
$int_department['asset_lost_tickets'] = $s;
$int_department['asset_dispose_tickets'] = $t;
$int_department['asset_unallocate_tickets'] = $un;
$int_department['asset_sold_tickets'] = $sold;
