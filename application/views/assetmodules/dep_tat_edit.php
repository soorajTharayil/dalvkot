                    ...
                    <table class=" table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang_loader('pcf','pcf_parameter'); ?></th>
                                <th><?php echo lang_loader('pcf','pcf_tat_l1_escalation'); ?></th>
                                <th><?php echo lang_loader('pcf','pcf_tat_l1_escalation'); ?></th>
                            </tr>
                        </thead>
                        <!-- table head end -->
...
<script>
    ...
    for (var i = 0; i < departments.length; i++) {
        ...
        if (l2Value < l1Value) {
            alert('TAT Close L2 should be greater than TAT Close L1 for department: ' + department.description);
