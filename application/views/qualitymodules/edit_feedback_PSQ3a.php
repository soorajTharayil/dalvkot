        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>
                                    Total no. of readmission to ICU within 48 hours after discharged</b></td>
                            <td>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        // Validate inputs for prescriptionsInCapitals
        if (prescriptionsInCapitals < 0) {
            alert("Total number of readmission to ICU within 48 hours.");
            return;
        }

        if (prescriptionsInCapitals > totalPrescriptions && totalPrescriptions !== 0) {
