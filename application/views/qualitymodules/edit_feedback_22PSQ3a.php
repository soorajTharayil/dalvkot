            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;22. PSQ3c - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_22PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                        <tr>
                            <td><b>Sum of total patient-in time for consultation</b></td>
                            <td>
...
<script>
    ...
    function calculateTime() {
        ...
        // --- ZERO HANDLING ADDED ---
        if (totalAdmissions === 0 || isNaN(totalAdmissions)) {
            // If numerator AND denominator are zero → result = 0:00:00
            if (totalSeconds === 0) {
            ...
            // If numerator > 0 and denominator = 0 → infinite time per patient
