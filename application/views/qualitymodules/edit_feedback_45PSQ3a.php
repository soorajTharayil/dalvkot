        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_45PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (totalPrescriptions < 0) {
            alert("Enter no. of patients with bronchiolitis");
            return;
        }

        // Keep original numerator > denominator check
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("No. of patients treated inappropriately must be less than the total no. of patients with bronchiolitis");
            return;
        }
