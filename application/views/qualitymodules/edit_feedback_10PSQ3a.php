            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;10. PSQ3a - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_10PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                            ...
                            <td>
                                <div style="display: flex; flex-direction: row; align-items: center;">
                                    <span class="has-float-label">
                                        <input class="form-control" value="<?php echo $param['initial_assessment_hr']; ?>" name="initial_assessment_hr" oninput="restrictToNumerals(event); calculateICUSMR();" type="number" id="formula_para1_hr" style="padding-top: 2px; padding-left: 6px; margin-top: 9px; width: 90%;" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <button type="button" class="btn btn-primary" onclick="calculateICUSMR()">
...
<script>
    ...
    document.querySelector('button[onclick="calculateICUSMR()"]').addEventListener('click', calculateICUSMR);

    function calculateICUSMR() {
        var actualDeathsInICU = parseInt(document.getElementById('formula_para1_hr').value);
        var predictedDeathsInICU = parseInt(document.getElementById('total_admission').value);

        document.querySelector('input[name="initial_assessment_hr"]').value = actualDeathsInICU;
        document.querySelector('input[name="total_admission"]').value = predictedDeathsInICU;
        ...
        if (actualDeathsInICU > predictedDeathsInICU) {
            alert("Actual number of deaths in ICU must be less than the predicted number of deaths in ICU.");
            return;
        }
        ...
        var calculatedResult = icuSMR % 1 === 0 ? icuSMR.toString() : icuSMR.toFixed(2);
