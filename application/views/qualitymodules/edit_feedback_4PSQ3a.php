...
<script>
    ...
    function calculateMedicationErrorRate() {
        ...
        // Format to whole or 2 decimals
        var calculatedResult = errorRatePercentage % 1 === 0 ?
