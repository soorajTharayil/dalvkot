            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;12. PSQ3a -
                        <?php echo $row->id; ?></h3>
                                ...
                                <div style="display: flex; flex-direction: row; align-items: center;">
                                    <span class="has-float-label">
                                        <input class="form-control"
                                            ...
                                            oninput="restrictToNumerals(event); calculatePressureUlcersKPI();"
...
<script>
    ...
    function calculatePressureUlcersKPI() {
        ...
        // If denominator is zero, define result as 0 (safe handling)
        if (totalPatientDays === 0) {
            pressureUlcersKPI = 0;
        } else {
