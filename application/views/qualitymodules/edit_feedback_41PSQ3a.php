        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_41PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter sum of functional gain patients in neurorehabilitation");
            return;
        }
        ...
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("Enter functional gain before discharge must be less than total no. of patients undergoing neurorehabilitation");
            return;
        }
