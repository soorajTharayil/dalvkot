        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_38PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        // Denominator 0 with numerator > 0 is invalid
        if (totalPrescriptions === 0 && prescriptionsInCapitals > 0) {
            alert("No. of patients sedated for colonoscopy procedure must be less than the total no. of patients undergoing Colonoscopy");
            return;
        }

        // Keep your original numerator > denominator check
