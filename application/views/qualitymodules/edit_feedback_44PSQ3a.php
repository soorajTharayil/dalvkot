        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_44PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        var prescriptionsInCapitals = parseInt(document.getElementById('formula_para1_hr').value) || 0;
        var totalPrescriptions = parseInt(document.getElementById('total_admission').value) || 0;
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter no. of stroke patients with DTN time within 60 minutes");
            return;
        }

        // Validate denominator (allow 0)
        if (totalPrescriptions < 0) {
            alert("Enter no. of stroke patients receiving thrombolytic therapy");
            return;
        }

        // Keep original numerator > denominator check
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("Enter no. of stroke patients with DTN of 60 minutes must be less than the total stroke patients who receive thrombolytic therapy");
            return;
        }

        // Calculate percentage (0 if denominator is 0)
