        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_33PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (isNaN(prescriptionsInCapitals) || prescriptionsInCapitals < 0) {
            alert("Enter no. of patients discharged with diagnosis of CHF with reduced EF");
            return;
        }

        // Allow zero, only disallow negative
        if (isNaN(totalPrescriptions) || totalPrescriptions < 0) {
            alert("Enter total no. of patients discharged with diagnosis of CHF");
            return;
        }

        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("Enter no. of patients discharged with CHF with reduced EF must be less than those with CHF");
            return;
        }

        var calculatedResult;

        // Case: both numerator and denominator are 0
        if (prescriptionsInCapitals === 0 && totalPrescriptions === 0) {
            calculatedResult = 0;
        }
        // Case: denominator is 0 → avoid divide-by-zero
