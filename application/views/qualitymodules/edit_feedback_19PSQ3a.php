            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;19. PSQ3c - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_19PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                            ...
                            <td>
                                <div style="display: flex; flex-direction: row; align-items: center;">
                                    <span class="has-float-label">
                                        <input class="form-control" value="<?php echo $param['initial_assessment_hr']; ?>" name="initial_assessment_hr" oninput="restrictToNumerals(event); calculateRescheduledSurgeriesRate();" type="number" id="formula_para1_hr" style="padding-top: 2px; padding-left: 6px; margin-top: 9px; width: 90%;" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <button type="button" class="btn btn-primary" onclick="calculateRescheduledSurgeriesRate()">
                                    <input type="hidden" id="formattedTime" name="formattedTime" value="">


                                    Calculate re-scheduling of surgeries
                                </button>
                            </td>
                        </tr>
                        <tr>
...
<script>
    ...
    document.querySelector('button[onclick="calculateRescheduledSurgeriesRate()"]').addEventListener('click', calculateRescheduledSurgeriesRate);

    function calculateRescheduledSurgeriesRate() {
        ...
        // Check numerator > denominator only when denominator > 0
        if (totalInPatients > 0 && patientsWithReactions > totalInPatients) {
            alert("The number of cases rescheduled must be less than the number of surgeries planned.");
            return;
        }
        ...
        if (totalInPatients === 0) {
            ...
            calculatedResult = ((patientsWithReactions / totalInPatients) * 100).toFixed(2);
        }
