            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;11. PSQ3a - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_11PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                            ...
                            <td>
                                <div style="display: flex; flex-direction: row; align-items: center;">
                                    <span class="has-float-label">
                                        <input class="form-control" value="<?php echo $param['initial_assessment_hr']; ?>" name="initial_assessment_hr" oninput="restrictToNumerals(event); calculateReturnToEmergencyKPI();" type="number" id="formula_para1_hr" style="padding-top: 2px; padding-left: 6px; margin-top: 9px; width: 90%;" />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <br>
                                <button type="button" class="btn btn-primary" onclick="calculateReturnToEmergencyKPI()">
                                    <input type="hidden" id="formattedTime" name="formattedTime" value="">


                                    Calculate returns to emergency
                                </button>
                            </td>
                        </tr>
                        <tr>
                            <td><b>Percentage of return to the emergency department within 72 hours with similar presenting complaints</b></td>
                            <td>
...
<script>
    ...
    document.querySelector('button[onclick="calculateReturnToEmergencyKPI()"]').addEventListener('click', calculateReturnToEmergencyKPI);

    function calculateReturnToEmergencyKPI() {
        var returnsToEmergency = parseInt(document.getElementById('formula_para1_hr').value);
        var totalPatients = parseInt(document.getElementById('total_admission').value);

        document.querySelector('input[name="initial_assessment_hr"]').value = returnsToEmergency;
        document.querySelector('input[name="total_admission"]').value = totalPatients;
        ...
        if (returnsToEmergency > totalPatients) {
            alert("Number of returns to emergency within 72 hours must be less than the total no. of patients who have come to the emergency.");
            return;
        }
        ...
        var calculatedResult = returnToEmergencyKPI % 1 === 0 ?
            returnToEmergencyKPI.toString() :
            returnToEmergencyKPI.toFixed(2);
