        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_47PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter no. of patients who developed adverse reaction");
            return;
        }

        // Validate denominator (allow 0)
        if (totalPrescriptions < 0) {
            alert("Enter no. of patients receiving the radiopharmaceutical");
            return;
        }

        // Keep original numerator > denominator check
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("No. of patients who developed adverse reaction(s) must be less than the no. of radiopharmaceutical patients");
            return;
        }
