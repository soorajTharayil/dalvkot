        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_43PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter no. of COPD patients provided with COPD action plan");
            return;
        }
        ...
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("No. of COPD patients given action plan must be less than the number of COPD patients discharged");
            return;
        }
