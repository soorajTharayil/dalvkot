        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_35PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (isNaN(prescriptionsInCapitals) || prescriptionsInCapitals < 0) {
            alert("Enter no. of patients with hypoglycemic events where the target glucose level was achieved");
            return;
        }

        // Allow zero instead of <= 0
        ...
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("Enter no. of patients achieving glucose level is must be less than total hypoglycemic events");
            return;
        }

        var calculatedResult;

        // If both values are zero → result = 0
        if (prescriptionsInCapitals === 0 && totalPrescriptions === 0) {
            calculatedResult = 0;
        }
        // If denominator is zero → avoid division, return 0
