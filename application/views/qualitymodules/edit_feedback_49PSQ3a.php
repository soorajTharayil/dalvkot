            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_discharge_feedback_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;23d. PSQ4c - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_49PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateTime() {
        ...
        var totalAdmissions = parseInt(document.getElementById('total_admission').value) || 0;

        var totalSeconds = (hr * 3600) + (min * 60) + sec;

        var averageSeconds = 0;
        if (totalAdmissions !== 0) {
            averageSeconds = totalSeconds / totalAdmissions;
        }
