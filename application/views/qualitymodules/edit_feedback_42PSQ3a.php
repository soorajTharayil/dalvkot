        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_42PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter no. of sepsis patients receiving Hour-1 bundle care");
            return;
        }
        ...
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("No. of sepsis patients treated as per Hour-1 bundle must be less than the total number of sepsis cases");
            return;
        }
