        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_50PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter no. of dialysis patients with target hemoglobin");
            return;
        }

        if (prescriptionsInCapitals > totalPrescriptions && totalPrescriptions !== 0) {
            alert("No. of dialysis patients achieving hemoglobin levels must be less than the total no. of dialysis patients");
            return;
        }

        // Calculate the percentage of compliance rate
