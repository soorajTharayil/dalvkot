        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_40PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter no. of POCT tests which resulted in clinical intervention");
            return;
        }

        // Validate denominator (allow 0)
        if (totalPrescriptions < 0) {
            alert("Enter no. of POCT tests where clinical intervention was necessary");
            return;
        }

        // Keep original numerator > denominator check
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("No. of POCT tests with clinical intervention must be less than tests requiring intervention");
            return;
        }
