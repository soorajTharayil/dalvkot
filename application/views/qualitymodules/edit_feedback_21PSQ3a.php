...
<script>
    ...
    function calculateNursePatientRatio() {
        ...
        // Allow zero, but if both are zero -> ratio is 0:0
        ...
        // If only nursingStaff is zero → infinite patients per nurse
        ...
        // If only occupiedBeds is zero → infinite nurses per patient
