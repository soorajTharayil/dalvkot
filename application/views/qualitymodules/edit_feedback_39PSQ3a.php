        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('quality/edit_feedback_39PSQ3a_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
...
<script>
    ...
    function calculateAdverseDrugReactionRate() {
        ...
        if (prescriptionsInCapitals < 0) {
            alert("Enter no. of cases where bile duct injuries occurred");
            return;
        }

        // Validate denominator (allow 0, block negatives)
        if (totalPrescriptions < 0) {
            alert("Enter total no. laparoscopic cholecystectomies performed");
            return;
        }

        // Keep original numerator > denominator check
        if (prescriptionsInCapitals > totalPrescriptions) {
            alert("No. of cases where bile duct injuries occurred must be less than the no. of Laparoscopic cholecystectomies performed");
            return;
        }
