...
$ip_tickets_count = $this->ipd_model->feedback_and_ticket($table_feedback, $table_tickets, $sorttime);
// tooltips
$ip_open_tickets = $this->ipd_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $open);
$ip_reopen_tickets = $this->ipd_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $reopen);

$ip_closed_tickets = $this->ipd_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $closed);
$ip_addressed_tickets = $this->ipd_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $addressed);
...
$ticket_resolution_rate_ip = $this->ipd_model->ticket_resolution_rate($table_tickets, $closed, $table_feedback);
$close_rate_ip = $this->ipd_model->ticket_rate($table_tickets, $status, $table_feedback, $table_ticket_action);
...
$selectionarray = $this->ipd_model->reason_to_choose_hospital($table_feedback, $sorttime);
