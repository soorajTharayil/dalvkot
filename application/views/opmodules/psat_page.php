<div class="content">
	...
	$ip_psat = $this->opf_model->psat_analytics($table_patients, $table_feedback, $table_tickets, $asc);
	?>
	<!-- Metric Boxes-->
	<div class="row">
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" title="<?php echo $psat_info_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('op','op_psat'); ?></div>
						<div class="icon">
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" data-toggle="tooltip" title="<?php echo $satisfiedpatients_info_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('op','op_psat_satisfied'); ?></div>
						<div class="icon">
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" title="<?php echo $unsatisfiedpatients_info_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('op','op_unsatisfied_patients'); ?></div>
						<div class="icon">
