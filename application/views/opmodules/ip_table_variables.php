...
$ip_tickets_count = $this->opf_model->feedback_and_ticket($table_feedback, $table_tickets, $sorttime);
// tooltips
$ip_open_tickets = $this->opf_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $open);
$ip_reopen_tickets = $this->opf_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $reopen);

$ip_closed_tickets = $this->opf_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $closed);
$ip_addressed_tickets = $this->opf_model->tickets_feeds($table_feedback, $table_tickets, $sorttime, $addressed);
...
// $ip_department = $this->departmenthead_model->departmenthead_values($table_patients, $table_feedback, $table_tickets, $sorttime, $department, $setup, $type);
$ticket_analisys = $this->opf_model->tickets_recived_by_department($type, $table_feedback, $table_tickets);
...
$selectionarray = $this->opf_model->reason_to_choose_hospital($table_feedback, $sorttime);
// $close_rate = $this->opf_model->ticket_rate($table_tickets, $table_ticket_action, $closed);
// $close_time = $this->opf_model->convertSecondsToTime($close_rate);
