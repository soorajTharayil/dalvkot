...
<div class="content">
    ...
    <?php if (isfeature_active('EDIT-PATIENT') === true || isfeature_active('VIEW-PATIENT') === true  || isfeature_active('ADD-PATIENT') === true || isfeature_active('DISCHARGE-PATIENT') === true) { ?>
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-body" style="height: 100px;">
                                    <div class="statistic-box">
                                        <h2><br></h2>
                                        <div class="small"><?php echo lang_loader('global', 'global_add_patient'); ?></div>
                                        <div class="icon">
                                            <i class="fa fa-user-plus"></i>
                                        </div>
                                        <a href="<?php echo base_url() . 'patient/create'; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('global', 'global_add_patient'); ?></a>
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-body" style="height: 100px;">
                                    <div class="statistic-box">
                                        ...
                                        <div class="small"><?php echo lang_loader('global', 'global_admitted_patients'); ?></div>
                                        <div class="icon">
                                            <i class="fa fa-plus"></i>
                                        </div>
                                        <a href="<?php echo base_url() . 'patient'; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('global', 'global_view_list'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-body" style="height: 100px;">
                                    <div class="statistic-box">
                                        ...
                                        <div class="small"><?php echo lang_loader('global', 'global_discharged_patients'); ?></div>
                                        <div class="icon">
                                            <i class="fa fa-check"></i>
                                        </div>
                                        <a href="<?php echo base_url() . 'patient/discharged'; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('global', 'global_view_list'); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    <?php if (isfeature_active('DISCHARGE-PATIENT') === true) { ?>
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-body" style="height: 100px;">
                                    <div class="statistic-box">
                                        ...
                                        <div class="small"><?php echo lang_loader('global', 'global_total_patients'); ?></div>
                                        <div class="icon">
                ...
                <div class="panel panel-default ">
                    ...
                    <?php if (ismodule_active('ADMISSION SECTION') === true  && isfeature_active('ADD-PATIENT') === true) { ?>
                        <div class="panel-heading " style="display: none;">
                            ...
                            <div class="btn-group">
                                <a class="btn btn-success" href="<?php echo base_url("patient/create") ?>"> <i class="fa fa-plus"></i> <?php echo lang_loader('global', 'global_new_patient'); ?> </a>
                                ...
                                <table class="datatabledp table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo lang_loader('global', 'global_ward'); ?></th>
                                            <th><?php echo lang_loader('global', 'global_bed_no'); ?></th>
                                            <th><?php echo lang_loader('global', 'global_date'); ?></th>
                                            <?php if (ismodule_active('ADMISSION SECTION') === true  && isfeature_active('EDIT-PATIENT') === true) { ?>
                                                <th class="center">
                                                ...
                                                <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
                                                    ...
                                                    <?php if (ismodule_active('ADMISSION SECTION') === true  && isfeature_active('EDIT-PATIENT') === true) { ?>
                                                        ...
                                                        <td style="text-align :center;">
                                                            ...
                                                            <a href="<?php echo base_url("patient/edit/$patient->id") ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></a>
                                                        </td>
                                                   ...
                                                   <?php if (ismodule_active('ADMISSION SECTION') === true  && isfeature_active('DISCHARGE-PATIENT') === true) { ?>
                                                      ...
                                                      <?php  $confirm = $patient->name; ?>
                                                        <td style="text-align :center;">
                                                            ...
                                                            <a href="<?php echo base_url("patient/patient_discharge/$patient->patient_id") ?>" class="btn btn-xs btn-success" onclick="return confirm('<?php echo 'Discharge ' . $confirm . '? and send message' ?>')"><i class="fa fa-check"></i></a>
                                                        </td>
                                                     
                                                            <td style="text-align :center;">

                                                                <a href="<?php echo base_url("patient/patient_damar/$patient->patient_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo 'Discharge ' . $confirm . '?  without message' ?>')"><i class="fa fa-close"></i></a>
                                                            </td>
