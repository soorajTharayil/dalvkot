	...
	<div class="row">
		...
		<div class="col-sm-12">
			...
			<div class="panel-heading no-print">
                    <div class="btn-group">
                  <a href="<?php echo base_url("question/add") ?>"> <button class="btn btn-success" > <i class="fa fa-plus"></i> <?php echo lang_loader('isr','isr_add_question'); ?> </button></a>  
                    </div>
                </div>
				<div class="panel-body">
					...
					<table class="datatable table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
							...
							<th><?php echo lang_loader('isr','isr_title'); ?></th>
							<th><?php echo lang_loader('isr','isr_questions'); ?></th><?php echo lang_loader('isr','isr_questions'); ?>
							...
							<th><?php echo lang_loader('isr','isr_shortkey'); ?></th>
							<th><?php echo lang_loader('isr','isr_title_2l'); ?></th>
							<th><?php echo lang_loader('isr','isr_ques_2l'); ?></th>
							<th><?php echo lang_loader('isr','isr_title_3l'); ?></th>
							<th><?php echo lang_loader('isr','isr_lang_3l'); ?></th>
							<th><?php echo lang_loader('isr','isr_action'); ?></th>
