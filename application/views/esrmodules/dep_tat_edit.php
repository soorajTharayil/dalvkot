                    ...
                    <table class=" table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?php echo lang_loader('isr', 'isr_parameter'); ?></th>
                                <th><?php echo lang_loader('isr', 'dept_level_escalation'); ?></th>
                                <th><?php echo lang_loader('isr', 'isr_tat_l1_escalation'); ?></th>
                                <th><?php echo lang_loader('isr', 'isr_tat_l2_escalation'); ?></th>
                            </tr>
                        </thead>
                        <!-- table head end -->
