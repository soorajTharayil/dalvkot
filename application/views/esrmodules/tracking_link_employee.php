                ...
                <div class="panel-body">
                    ...
                    <?php if ($this->session->userdata['isLogIn'] == false) { ?>
                        ...
                        <?php if ($department->status == 'Addressed') { ?>
                            <span class="navheader"><?php echo lang_loader('isr', 'isr_inprogress'); ?></span>
                        ...
                        <?php if ($department->status == 'Open') { ?>
                            <span class="navheader" style="color: #d9534f;">Assigned</span>
                    ...
                    <?php if ($department->status == 'Closed') { ?>
                        ...
                        <p class="message-note">
                            <?php if ($department->status == 'Closed' && $department->patient_verified_status == 1) { ?>
                                Request resolution verified by the staff.
                            <?php } ?>
                        </p>
                        <br>
                        <?php if ($department->status == 'Closed' && $department->patient_verified_status == 0) { ?>
                            <p><strong>Has your request been resolved?</strong></p>

                            <div id="emoji-options">
                                <?php echo form_open('ticketsesr/create', 'class="form-inner" id="emojiForm"') ?>
                        ...
                        <div id="reopen-question" style="display: none; text-align: center;">
                            <p>Do you want to reopen the request?</p>
                        ...
                        <input type="hidden" name="patient_reopen_name" value="<?php echo $param['name']; ?>">
                            ...
                            <p>Please let us know the reason for reopening the request:</p>
                    ...
                    <?php if ($department->status == 'Addressed') { ?>
                        <p class="message-note">
                            Your concern has been assigned to one of our executives, and they are actively working on resolving it.
                        </p>
                    <?php } ?>
                    <?php if ($department->status == 'Open') { ?>
                        <p class="message-note">
                            Your concern has been registered, and it has been assigned to one of our executives.
                        </p>
                    <?php }  ?>
                    <style>
                        .message-note {
                    ...
                    <?php if ($department->status == 'Closed') { ?>
                        <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                            <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                                <tr>
                                    <td class="inbox-item-author" colspan="2" style="text-align: center;"><b>Request Summary</b></td>
                                </tr>
                                ...
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:30px;"><?php echo lang_loader('isr', 'isr_issue_concerns'); ?></td>
                                ...
                                <?php if ($comment) { ?>
                                    <tr style="margin-left: 10px;margin-right: 10px;">
                                        <td style="text-align: left;width:30px;"><?php echo lang_loader('isr', 'isr_comment'); ?></td>
                                        <td style="text-align: left;">
                                            <?php echo '"' . $comment . '"'; ?>
                                        </td>
                                    </tr>
                                ...
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:30px;"><?php echo lang_loader('isr', 'isr_created_on'); ?></td>
                                    <td style="text-align: left;">
                    ...
                    <?php } else { ?>
                        ...
                        <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                            <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                                <tr>
                                    <td class="inbox-item-author" colspan="2" style="text-align: center;"><b><?php echo lang_loader('isr', 'isr_request_details'); ?></b></td>
                                </tr>
                                <span class="navheader">
                                    <tr style="margin-left: 10px;margin-right: 10px;">
                                        <td style="text-align: left;width:30px;"><?php echo lang_loader('isr', 'isr_priority'); ?></td>
                                        <td style="text-align: left;">
                                ...
                                <tr style="margin-left: 10px;margin-right: 10px;">
                                    <td style="text-align: left;width:30px;"><?php echo lang_loader('isr', 'isr_site'); ?></td>
                                    <td style="text-align: left;">
                                ...
                                <?php if ($department->last_modified > $department->created_on) { ?>
                                    <tr style="margin-left: 10px;margin-right: 10px;">
                                        <td style="text-align: left;width:30px;"><?php echo lang_loader('isr', 'isr_updated_on'); ?></td>
                                        <td style="text-align: left;">
                                            <?php echo date('g:i a,', strtotime($department->last_modified)); ?>
                                            <?php echo date('d-m-y', strtotime($department->last_modified)); ?>
                                        </td>
                        ...
                        <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                            <?php if (isr_tat('department_information') === true) { ?>
                                <?php if ($department->department->pname) { ?>
                                    <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                                        <tr>
                                            <td class="inbox-item-author" colspan="2" style="text-align: center;"><b><?php echo lang_loader('isr', 'isr_department_info'); ?></b></td>
                                        </tr>
                                        <tr style="margin-left: 10px;margin-right: 10px;">
                                            <td style="text-align: left;width:30px;"> <?php echo lang_loader('isr', 'isr_department_name'); ?></td>
                                            <td style="text-align: left;"><?php echo $department->department->description; ?></td>
                                        </tr>

                                        <tr style="margin-left: 10px;margin-right: 10px;">
                                            <td style="text-align: left;width:30px;"><?php echo lang_loader('isr', 'isr_contact'); ?></td>
                                            <td style="text-align: left;">
                            ...
                            <?php } else { ?>
                                <table class="table table-no-border no-footer no-header" style="display:none;">
                                    <tr>
                                        <td class="inbox-item-author" colspan="2" style="text-align: center;"><b><?php echo lang_loader('isr', 'isr_did_you_know'); ?></b></td>
                                    </tr>
                            ...
                            <div class="inbox" style=" margin-bottom: 0px; margin-top: 0px;">
                                ...
                                <table class="table table-striped table-bordered  no-footer dtr-inline collapsed">
                                    <tr>
                                        <td class="inbox-item-author" colspan="2" style="text-align: center;"><b><?php echo lang_loader('isr', 'isr_employee_info'); ?></b></td>
                                    </tr>
                                    <tr colspan="2" style="margin-left: 10px;margin-right: 10px;">
