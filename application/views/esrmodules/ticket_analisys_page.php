<div class="content">
	...
	$ip_feedbacks_count = $this->isr_model->patient_and_feedback($table_patients, $table_feedback, $sorttime, $setup);
	$ip_psat = $this->isr_model->psat_analytics($table_patients, $table_feedback, $table_tickets, $asc);
	?>
	<!-- Metric Boxes-->
	<div class="row">
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('isr','isr_total_request'); ?><a href="javascript:void()" data-toggle="tooltip" title="<?php echo $totaltickect_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
						<div class="icon">
		...
		<?php if (ticket_addressal('isr_addressal') === true) { ?>
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							<h2><span class="count-number"><?php echo $isr_department['addressedtickets']; ?></span> <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span></h2>
							...
							<a href="<?php echo $int_link_addressedtickets; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('isr','isr_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;">
					<div class="statistic-box">
						...
						<div class="small"><?php echo lang_loader('isr','isr_total_feedbacks'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $totalfeedback_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
						<div class="icon">
							<i class="fa fa-comments-o"></i>
						</div>
					</div>
					<a href="<?php echo $ip_link_feedback_report; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('isr','isr_view_list'); ?></a>
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<table class="isrticketanalisys table table-striped table-bordered table-hover" cellspacing="0" width="100%">
				<thead>
					<th><?php echo lang_loader('isr','isr_slno'); ?></th>
					<th><?php echo lang_loader('isr','isr_department'); ?></th>
					<!-- <th>Percentage</th> -->
					<th><?php echo lang_loader('isr','isr_s_total_requests'); ?></th>
					<th><?php echo lang_loader('isr','isr_s_open_requests'); ?></th>
					<th>Assigned requests</th>
					<!-- change here according to helper -->
					<?php if (ticket_addressal('isr_addressal') === true) { ?>
						<th><?php echo lang_loader('isr','isr_s_addressed_requests'); ?></th>
					<?php } ?>
					<th><?php echo lang_loader('isr','isr_s_closed_requests'); ?></th>
					<th>Reopened requests</th>
					<?php if ($this->uri->segment(2) == "ticket_resolution_rate") { ?>
						<th><?php echo lang_loader('isr','isr_resolution_rate'); ?></th>
					<?php } ?>
					<?php if ($this->uri->segment(2) == "average_resolution_time") { ?>
						<th><?php echo lang_loader('isr','isr_avg_resolution_time'); ?></th>
					<?php } ?>
				</thead>
				<?php $sl = 1;
				$i = 0; ?>
