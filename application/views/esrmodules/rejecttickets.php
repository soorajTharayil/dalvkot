		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<div class="panel-heading" style="text-align: right;">
						<div class="btn-group">
							<a class="btn btn-success" data-placement="bottom" data-toggle="tooltip" title="<?php echo lang_loader('isr','isr_download_addressed_incident_report_tooltip'); ?>" href="<?php echo base_url($this->uri->segment(1)) . '/download_opentickets' ;?>">
					...
					<?php   if (isfeature_active('ISR-REQUESTS-DASHBOARD') === true) { ?>
							<form>
								<p> 
									<!-- <span style="font-size:15px; font-weight:bold;"><?php echo lang_loader('isr','isr_sort_incident_by'); ?></span> -->
									...
									<?php if (isset($_GET['depsec'])) { ?>
										...
										<select name="dep" class="form-control" onchange="gotonextdepartment(this.value)" style="width:200px; margin:0px 0px 20px 20px;">
											<option value="1" selected><?php echo lang_loader('isr','isr_select_incident'); ?></option>
											<?php
											$this->db->where('type', 'esr');
						...
						<table class="incticketsaddressed table table-striped table-bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th style="white-space: nowrap;"><?php echo lang_loader('isr','isr_incidents_id'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('isr','isr_incident_reported_by'); ?></th>
									<th style="white-space: nowrap;"><?php echo lang_loader('isr','isr_incident'); ?></th>
									<?php   if (isfeature_active('ISR-REQUESTS-DASHBOARD') === true) { ?>
									...
									<th style="text-align: center;"><?php echo lang_loader('isr','isr_status'); ?></th>
								</tr>
							</thead>
							<tbody>
								<?php if (!empty($departments)) {		?>
									...
									?>
										<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>" data-placement="bottom" data-toggle="tooltip" title="<?php echo $rowmessage; ?>">
											<td><?php echo $sl; ?></td>
											<td><?php echo lang_loader('isr','isr_inc'); ?><?php echo $department->id; ?></td>
