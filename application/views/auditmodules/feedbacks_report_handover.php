					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM11') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Monitors safe, complete patient handover including ID, vitals, meds, risks & pending results as per NABH, JCI, CAHO & WHO communication standards (SBAR/IPASS) to ensure continuity of care.</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $handover_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td>
											<a href="<?php echo $handover_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_handover"; // Replace with your API endpoint
