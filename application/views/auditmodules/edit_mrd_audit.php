            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;MRD file audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_mrd_audit_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary" onclick="calculateTimeFormat()">
                                    ...
                                    Calculate time taken for initial assessment
                                </button>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <?php if ($param['consent_comment']) { ?>
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="consent_comment" value="<?php echo $param['consent_comment']; ?>"></td>
                            </tr>
                        <?php  } ?>
                        <tr>
