			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'Medication management process audit';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM9') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Assesses safe prescribing, dispensing & administration of medications as per NABH, JCI, CAHO, WHO Medication Safety, ISMP & CDSCO standards to ensure compliance and patient safety.</td>
								</tr>
								<tr>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>MEDICATION MANAGEMENT PROCESS AUDIT - Audit Summary</strong>
						</div>
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								title="Download detailed audit report"
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_medicine_audit' ?>">
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $medicine_dispensing_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td>
											<a href="<?php echo $medicine_dispensing_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_medicine_dispense"; // Replace with your API endpoint
