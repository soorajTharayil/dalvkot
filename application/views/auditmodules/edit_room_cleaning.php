            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Patient room cleaning checklist - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_room_cleaning_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="furniture_dusted"
                                value="<?php echo isset($param['diagnostic']) ? htmlspecialchars($param['diagnostic'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                            <div style="margin-top:5px;">
                                Remarks: <input class="form-control" type="text" name="furniture_dusted_text"
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="fan_cleaned"
                                value="<?php echo isset($param['lab_results']) ? htmlspecialchars($param['lab_results'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                            <div style="margin-top:5px;">
                                Remarks: <input class="form-control" type="text" name="fan_cleaned_text"
                    ...
                    <tr>
                        <td><b>Is the room maintained with a fresh smell?</b></td>
                        <td>
                    ...
                    <tr>
                        <td><b>Are toilets and washbasins cleaned properly?</b></td>
                        <td>
