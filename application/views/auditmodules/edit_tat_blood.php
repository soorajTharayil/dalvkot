            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;TAT for blood issue - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_feedback_tat_blood_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                            ...
                            <td>
                                <select class="form-control" name="department">
                                    ...
                                    foreach ($departments as $d) {
                                        $selected = ($param['dep'] == $d['title']) ? 'selected' : '';
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="benchmark" value="<?php echo $param['benchmark']; ?>"></td>
                        </tr>
                        <tr>
...
<script>
    ...
    function calculateTimeFormat() {
        ...
        if (isNaN(admissionDate.getTime())) {
            alert("Please enter transfusion request time.");
            return;
        }

        if (isNaN(assessmentDate.getTime())) {
            alert("Please enter blood received time.");
            return;
        }

        if (assessmentDate <= admissionDate) {
            alert("Blood received time must be greater than transfusion request time.");
            return;
        }
