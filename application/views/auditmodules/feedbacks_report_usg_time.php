					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM6') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Tracks USG waiting time from billing to report delivery as per NABH, WHO, ICMR, CDC, CAHO & JCI standards to enhance efficiency, streamline workflow, and improve patient satisfaction.</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $usg_wait_time_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td>
											<a href="<?php echo $usg_wait_time_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_usg_time"; // Replace with your API endpoint
