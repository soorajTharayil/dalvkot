			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'Nurse-Patient ratio for ICU';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM15') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Tracks ICU nurse-patient ratio to ensure safe staffing and quality care, aligned with NABH, JCI, CAHO, MoHFW & Indian Nursing Council standards for critical care units.</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $nurse_patient_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td><?php echo !empty($param->icu) ? $param->icu : '-'; ?></td>
										<td>
											<a href="<?php echo $nurse_patient_feedback . $id; ?>"
