			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'Turn around time for issue of blood and blood components';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM14') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Monitors turnaround time for blood and component requests to ensure timely transfusion, as per NABH, JCI, CAHO, NACO & WHO standards on blood bank safety and transfusion practices.</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $tat_blood_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td>
											<a href="<?php echo $tat_blood_feedback . $id; ?>"
