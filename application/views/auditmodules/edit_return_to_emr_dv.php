            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Return to Emergency- Data Verification - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_feedback_return_to_emr_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="same_op" value="<?php echo $param['same_op']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Patient condition at initial consultation in last 72 hours</b></td>
                            <td><input class="form-control" type="text" name="same_op_comment" value="<?php echo $param['same_op_comment']; ?>"></td>
                        </tr>
                        <tr>
