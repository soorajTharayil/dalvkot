					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> TAT for blood issue - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_tat_blood/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Transfusion Type</b></td>
										<td>
											<?php echo $result->transfusion; ?>
										</td>
									</tr>
									<tr>
										<td><b>Transfusion request time</b></td>
										<td>
											<?php echo $result->transfusion_request_time; ?>
										</td>
									</tr>
									<tr>
										<td><b>Blood received time</b></td>
										<td>
											<?php echo $result->blood_received_time; ?>
										</td>
									</tr>
									<tr>
										<td><b>TAT for issue of blood and blood components</b></td>
										<td>
											<?php echo $result->tat_blood; ?>
										</td>
									</tr>
									<tr>
										<td><b>Benchmark time</b></td>
										<td>
											<?php echo $result->benchmark; ?>
										</td>
									</tr>
									<tr>
										<td><b>Transfusion start time</b></td>
										<td>
											<?php echo $result->transfusion_started_time; ?>
										</td>
									</tr>
									<tr>
