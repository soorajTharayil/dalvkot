            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Urinary Catheter
                        maintenance checklist - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="balloon_size_adequate"
                                    value="<?php echo isset($param['identification_details']) ? htmlspecialchars($param['identification_details'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="balloon_size_adequate_text"
                        ...
                        <tr>
                            <td><b>Are appropriate hand hygiene and gloves used while handling the catheter or drainage
                                    bag?</b></td>
                            <td>
                                <input class="form-control" type="text" name="hand_hygiene_gloves"
                                    value="<?php echo isset($param['vital_signs']) ? htmlspecialchars($param['vital_signs'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="hand_hygiene_gloves_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="catheter_secured"
                                    value="<?php echo isset($param['surgery']) ? htmlspecialchars($param['surgery'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="catheter_secured_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="sterile_closed_system"
                                    value="<?php echo isset($param['complaints_communicated']) ? htmlspecialchars($param['complaints_communicated'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="sterile_closed_system_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="catheter_urethral_hygiene"
                                ...
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text"
                                        name="catheter_urethral_hygiene_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="urine_flow_unobstructed"
                                    value="<?php echo isset($param['output']) ? htmlspecialchars($param['output'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="urine_flow_unobstructed_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="drainage_bag_below_bladder"
                                    value="<?php echo isset($param['allergies']) ? htmlspecialchars($param['allergies'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text"
                                        name="drainage_bag_below_bladder_text"
                        ...
                        <tr>
                            <td><b>Are indwelling catheters or drainage bags changed only when clinically indicated and
                                    not at arbitrary fixed intervals?</b></td>
                            <td>
                                <input class="form-control" type="text" name="catheter_change_indicated"
                                    value="<?php echo isset($param['medication']) ? htmlspecialchars($param['medication'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text"
                                        name="catheter_change_indicated_text"
                        ...
                        <tr>
                            <td><b>If there are breaks in aseptic technique, disconnection, or leakage, is the catheter
                                    replaced using aseptic technique and sterile equipment?</b></td>
                            <td>
                                <input class="form-control" type="text" name="catheter_breaks_replacement"
                                    value="<?php echo isset($param['diagnostic']) ? htmlspecialchars($param['diagnostic'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text"
                                        name="catheter_breaks_replacement_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="periodic_perineal_care"
                                    value="<?php echo isset($param['lab_results']) ? htmlspecialchars($param['lab_results'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="periodic_perineal_care_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="urobag_emptied"
                                    value="<?php echo isset($param['pending_investigation']) ? htmlspecialchars($param['pending_investigation'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="urobag_emptied_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="pain_discomfort_assessed"
                                    value="<?php echo isset($param['medicine_order']) ? htmlspecialchars($param['medicine_order'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text"
                                        name="pain_discomfort_assessed_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="meatus_inspected"
                                    value="<?php echo isset($param['facility_communicated']) ? htmlspecialchars($param['facility_communicated'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="meatus_inspected_text"
                        ...
                        <tr>
                            <td><b>Is the catheter inspected where it enters the meatus for encrusted material and
                                    drainage?</b></td>
                            <td>
                                <input class="form-control" type="text" name="catheter_meatus_inspected"
                                    value="<?php echo isset($param['health_education']) ? htmlspecialchars($param['health_education'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text"
                                        name="catheter_meatus_inspected_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="encrusted_materials_removed"
                                    value="<?php echo isset($param['risk_assessment']) ? htmlspecialchars($param['risk_assessment'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text"
                                        name="encrusted_materials_removed_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="meatus_cleaned_daily"
                                    value="<?php echo isset($param['urethral']) ? htmlspecialchars($param['urethral'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="meatus_cleaned_daily_text"
                        ...
                        <tr>
                            <td><b>Is it ensured that the tubing does not go in and out of the urethra during
                                    cleaning?</b></td>
                            <td>
                                <input class="form-control" type="text" name="tubing_stable"
                                    value="<?php echo isset($param['urine_sample']) ? htmlspecialchars($param['urine_sample'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="tubing_stable_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="urine_culture_sterile"
                                    value="<?php echo isset($param['bystander']) ? htmlspecialchars($param['bystander'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="urine_culture_sterile_text"
