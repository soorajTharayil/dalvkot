			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'Retun to Emergency Department within 72 hours with similar presenting complaints- Data Verification';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM19') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Verifies ED revisit data within 24–72 hrs to ensure accurate documentation, monitor patient outcomes, and improve emergency care as per NABH, JCI, CAHO, MoHFW & ICMR standards.</td>
								</tr>
								<tr>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						<div>
							<strong>EMERGENCY RETURN REPORT-DATA VERIFICATION - Audit Summary</strong>
						</div>
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								title="Download detailed audit report"
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_emergency_verification' ?>">
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $return_to_emr_dv_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td>
											<a href="<?php echo $return_to_emr_dv_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_return_to_emr"; // Replace with your API endpoint
