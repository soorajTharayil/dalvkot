			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'Return to ICU within 48 hours after being discharged from ICU';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM16') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Monitors ICU readmissions within 48 hours of discharge to evaluate care quality, prevent adverse events, and improve outcomes as per NABH, JCI, CAHO, MoHFW & ICMR patient safety standards.</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $return_to_icu_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td>
											<a href="<?php echo $return_to_icu_feedback . $id; ?>"
