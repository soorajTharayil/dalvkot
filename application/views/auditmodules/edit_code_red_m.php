            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Code Red -
                        <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_feedback_mock_red_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="initial_assessment_hr2"
                                    value="<?php echo $param['initial_assessment_hr2']; ?>">
                            </td>
                        </tr>
                        <tr>
                            <td><b>Number of code announcements</b></td>
                            <td><input class="form-control" type="text" name="number_of_code"
                                    value="<?php echo $param['number_of_code']; ?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="respondents"
                                    value="<?php echo $param['respondents']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Have they tried to assess the situation?</b></td>
                            <td><input class="form-control" type="text" name="situation"
                                    value="<?php echo $param['situation']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Is there availability of fire fighting equipment?</b></td>
                            <td><input class="form-control" type="text" name="fire"
                                    value="<?php echo $param['fire']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Have they demonstrated the use of fire fighting equipment?</b></td>
                            <td><input class="form-control" type="text" name="demonstrated"
                                    value="<?php echo $param['demonstrated']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Is the lift closed?</b></td>
                            <td><input class="form-control" type="text" name="lift"
                                    value="<?php echo $param['lift']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Are the fire doors opened?</b></td>
                            <td><input class="form-control" type="text" name="doors"
                                    value="<?php echo $param['doors']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Has the patient safety officer announced evacuation?</b></td>
                            <td><input class="form-control" type="text" name="safety"
                                    value="<?php echo $param['safety']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Are transportation modes available for evacuation?</b></td>
                            <td><input class="form-control" type="text" name="transportation"
                                    value="<?php echo $param['transportation']; ?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="assembly_point"
                                    value="<?php echo $param['assembly_point']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Has the safety officer and team revisited the spot for follow-up?</b></td>
                            <td><input class="form-control" type="text" name="follow_up"
                                    value="<?php echo $param['follow_up']; ?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="deviations"
                                    value="<?php echo $param['deviations']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Have all events of Code Red been debriefed?</b></td>
                            <td><input class="form-control" type="text" name="debrief"
                                    value="<?php echo $param['debrief']; ?>"></td>
                        </tr>
                        <tr>
