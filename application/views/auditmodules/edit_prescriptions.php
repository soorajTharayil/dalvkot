                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="date_mentioned"
                                    value="<?php echo isset($param['date_mentioned']) ? htmlspecialchars($param['date_mentioned'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="date_mentioned_text"
                                        value="<?php echo isset($param['date_mentioned_text']) ? htmlspecialchars($param['date_mentioned_text'], ENT_QUOTES, 'UTF-8') : ''; ?>"
                                        placeholder="Remarks">
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="sign_doctor"
                                    value="<?php echo isset($param['sign_doctor']) ? htmlspecialchars($param['sign_doctor'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="sign_doctor_text"
                                        value="<?php echo isset($param['sign_doctor_text']) ? htmlspecialchars($param['sign_doctor_text'], ENT_QUOTES, 'UTF-8') : ''; ?>"
                                        placeholder="Remarks">
                                </div>
                            </td>
                        </tr>
