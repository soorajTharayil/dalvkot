						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3>
									...
									OP consultation time - <?php echo $result->id; ?>
								</h3>
							</div>
							<?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_op_consultation/$id") ?>">
							...
							<div class="panel-body" style="background: #fff;">
								<table class="table table-striped table-bordered no-footer dtr-inline" style="font-size: 16px;">
									...
									<tr>
										...
										<td><?php echo $result->register_time; ?></td>
									</tr>
									<tr>
										<td><b>Patients consultation room entry time</b></td>
										<td><?php echo $result->room_enter_time; ?></td>
									</tr>
									<tr>
										<td><b>Waiting time for consultation</b></td>
										<td><?php echo $result->consultation_wait_time; ?></td>
									</tr>
									<tr>
