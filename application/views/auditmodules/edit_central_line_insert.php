                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="alternatives_documented"
                                    value="<?php echo isset($param['identification_details']) ? htmlspecialchars($param['identification_details'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="alternatives_documented_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="patient_two_identifications"
                                    value="<?php echo isset($param['vital_signs']) ? htmlspecialchars($param['vital_signs'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="patient_two_identifications_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="clinical_reasons_documented"
                                    value="<?php echo isset($param['surgery']) ? htmlspecialchars($param['surgery'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="clinical_reasons_documented_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="informed_consent_obtained"
                                    value="<?php echo isset($param['complaints_communicated']) ? htmlspecialchars($param['complaints_communicated'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="informed_consent_obtained_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="hand_hygiene_performed"
                                    value="<?php echo isset($param['intake']) ? htmlspecialchars($param['intake'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="hand_hygiene_performed_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="ppe_worn"
                                    value="<?php echo isset($param['output']) ? htmlspecialchars($param['output'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="ppe_worn_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="sterile_gloves_used"
                                    value="<?php echo isset($param['allergies']) ? htmlspecialchars($param['allergies'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="sterile_gloves_used_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="insertion_kit_available"
                                    value="<?php echo isset($param['medication']) ? htmlspecialchars($param['medication'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="insertion_kit_available_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="site_prepared_hygiene"
                                    value="<?php echo isset($param['diagnostic']) ? htmlspecialchars($param['diagnostic'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="site_prepared_hygiene_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="site_positioned_draped"
                                    value="<?php echo isset($param['lab_results']) ? htmlspecialchars($param['lab_results'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="site_positioned_draped_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="local_anesthesia_used"
                                    value="<?php echo isset($param['pending_investigation']) ? htmlspecialchars($param['pending_investigation'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="local_anesthesia_used_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="aseptic_technique_maintained"
                                    value="<?php echo isset($param['medicine_order']) ? htmlspecialchars($param['medicine_order'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="aseptic_technique_maintained_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="lumens_not_cut"
                                    value="<?php echo isset($param['facility_communicated']) ? htmlspecialchars($param['facility_communicated'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="lumens_not_cut_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="unused_ports_clamped"
                                    value="<?php echo isset($param['health_education']) ? htmlspecialchars($param['health_education'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="unused_ports_clamped_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="blood_aspirated_site_cleaned"
                                    value="<?php echo isset($param['risk_assessment']) ? htmlspecialchars($param['risk_assessment'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="blood_aspirated_site_cleaned_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="site_checked_chlorhexidine"
                                    value="<?php echo isset($param['urethral']) ? htmlspecialchars($param['urethral'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="site_checked_chlorhexidine_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="sterile_dressing_applied"
                                    value="<?php echo isset($param['urine_sample']) ? htmlspecialchars($param['urine_sample'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="sterile_dressing_applied_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="placement_verified_xray"
                                    value="<?php echo isset($param['bystander']) ? htmlspecialchars($param['bystander'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="placement_verified_xray_text"
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="patient_education_documented"
                                    value="<?php echo isset($param['instruments']) ? htmlspecialchars($param['instruments'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                                <div style="margin-top:5px;">
                                    Remarks: <input class="form-control" type="text" name="patient_education_documented_text"
