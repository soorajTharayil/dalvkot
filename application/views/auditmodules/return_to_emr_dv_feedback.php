					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> Return to Emergency- Data Verification - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_return_to_emr_dv/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										<td><b>Initial consultaion date</b></td>
										<td>
											<?php echo $result->initial_consultaion; ?>
										</td>
									</tr>
									<tr>
										<td><b>Has same OP number been recorded in last 24 hours?</b></td>
										<td>
										<?php echo $result->same_op_tf; ?>
										</td>
									</tr>
									<tr>
										<td><b>Patient condition at initial consultation in last 24 hours</b></td>
										<td>
										<?php echo $result->same_op_tf_comment; ?>
										</td>
									</tr>
									<tr>
										<td><b>Has same OP number been recorded in last 48 hours?</b></td>
										<td>
										<?php echo $result->same_op_fe; ?>
										</td>
									</tr>
									<tr>
										<td><b>Patient condition at initial consultation in last 48 hours</b></td>
										<td>
										<?php echo $result->same_op_fe_comment; ?>
										</td>
									</tr>
									<tr>
										<td><b>Has same OP number been recorded in last 72 hours?</b></td>
										<td>
										<?php echo $result->same_op_st; ?>
										</td>
									</tr>
									<tr>
										<td><b>Patient condition at initial consultation in last 72 hours</b></td>
										<td>
										<?php echo $result->same_op_st_comment; ?>
										</td>
									</tr>
									<tr>
										<td><b>Patient condition at re-consultation</b></td>
										<td>
										<?php echo $result->re_consultation; ?>
										</td>
									</tr>
									<tr>
