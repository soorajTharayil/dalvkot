            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>">
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Laboratory safety audit - <?php echo $row->id; ?></h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <?php echo form_open_multipart('audit/edit_lab_safety_audit_byid/' . $this->uri->segment(3), 'class="form-inner"') ?>
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="idno" value="<?php echo $param['idno']; ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td><b>Is personal protective equipment being used appropriately?</b></td>
                            <td>
                                <input class="form-control" type="text" name="gloves"
                                    value="<?= htmlspecialchars($param['gloves'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </td>
                        </tr>

                        <tr>
                            <td><b>Is the staff dispose biomedical waste as per BMW Seggregation guidelines?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the patient identification confirmed by the staff prior to tests?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the staff wear Lab coat only in the laboratory and is removed before entering non-laboratory general use area?</b></td>
                            <td>
                                <input class="form-control" type="text" name="lead_apron"
                                    value="<?= htmlspecialchars($param['lead_apron'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </td>
                        </tr>

                        <tr>
                            <td><b>Is the staff maintained cleanliness in their working station?</b></td>
                            <td>
                                <input class="form-control" type="text" name="use_xray_barrior"
                                    value="<?= htmlspecialchars($param['use_xray_barrior'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </td>
                        </tr>

                        <tr>
                            <td><b>Is the staff follow sample disinfection before disposal (Autoclaving)?</b></td>
                            <td>
                                <input class="form-control" type="text" name="use_tld_badge"
                                    value="<?= htmlspecialchars($param['use_tld_badge'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </td>
                        </tr>

                        <tr>
                            <td><b>Is the staff follow adequate safety measures while handling biological safety cabinet?</b></td>
                            <td>
                        ...
                        <tr>
                            <td><b>Is the staff adhere to the No recapping of needle policy of the hospital?</b></td>
                            <td>
                                <input class="form-control" type="text" name="no_recapping"
                                    value="<?= htmlspecialchars($param['no_recapping'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </td>
                        </tr>

                        <tr>
                            <td><b>Is the staff follow the PTS disinfection protocol when a spillage of sample is noticed?</b></td>
                            <td>
                                <input class="form-control" type="text" name="pts_disinfection"
                                    value="<?= htmlspecialchars($param['pts_disinfection'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="form-control" type="text" name="dataAnalysis"
                                    value="<?= htmlspecialchars($param['dataAnalysis'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
                            </td>
                        </tr>
