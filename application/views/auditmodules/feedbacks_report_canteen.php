			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'Canteen Audit Checklist';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM33') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Audits canteen hygiene, food handling, storage, transport, pest control & staff training per NABH, JCI, FSSAI, CAHO & Indian hospital food safety and infection control standards.</td>
								</tr>
								<tr>
					...
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						...
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_canteen_audit' ?>">
						...
						<table class="activecasesmrd table table-striped table-hover table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $canteen_audit_feedback . $id; ?>';" style="cursor: pointer;">
										<td><?php echo $sl; ?></td>
										...
										<td>
											<a href="<?php echo $canteen_audit_feedback . $id; ?>"
