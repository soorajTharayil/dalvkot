                ...
                <div class="panel-body" style="background: #fff;">
                   ...
                   <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="relevant_details" 
                                value="<?php echo isset($param['relevant_details']) ? htmlspecialchars($param['relevant_details'], ENT_QUOTES, 'UTF-8') : ''; ?>">
                            <div style="margin-top:5px;">
                                Remarks: <input class="form-control" type="text" name="relevant_details_text" 
                                    value="<?php echo isset($param['relevant_details_text']) ? htmlspecialchars($param['relevant_details_text'], ENT_QUOTES, 'UTF-8') : ''; ?>" 
                                    placeholder="Remarks">
                            </div>
                        </td>
                    </tr>
