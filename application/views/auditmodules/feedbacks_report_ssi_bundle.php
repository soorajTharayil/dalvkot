			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'SSI Bundle Care Policy';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM26') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Ensures compliance with SSI bundle—pre, intra & post-op care, sterile technique, antibiotic prophylaxis & documentation—as per NABH, JCI, CAHO & Indian surgical infection prevention standards.</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $ssi_bundle_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td>
											<a href="<?php echo $ssi_bundle_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_ssi_bundle"; // Replace with your API endpoint
