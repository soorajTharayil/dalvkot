                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-primary" onclick="calculateTimeFormat()">
                                    ...
                                    Calculate OP consultation waiting time
                                </button>
                            </td>
                        </tr>
                        <tr>
...
<script>
    ...
    function calculateTimeFormat() {
        ...
        if (isNaN(admissionDate.getTime())) {
            alert("Please enter registration time.");
            return;
        }

        if (isNaN(assessmentDate.getTime())) {
            alert("Please enter consultation room entry time.");
            return;
        }

        if (assessmentDate <= admissionDate) {
            alert("Consultation room entry time must be greater than registration time.");
            return;
        }
