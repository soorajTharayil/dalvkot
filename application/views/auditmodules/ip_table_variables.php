...
// $ip_department = $this->departmenthead_model->departmenthead_values($table_patients, $table_feedback, $table_tickets, $sorttime, $department, $setup, $type);
$ticket_analisys = $this->audit_model->tickets_recived_by_department($type, $table_feedback, $table_tickets);
...
$ticket_resolution_rate = $this->audit_model->ticket_resolution_rate($table_tickets, $closed, $table_feedback);
$close_rate = $this->audit_model->ticket_rate($table_tickets, $status, $table_feedback, $table_ticket_action);
$ticket_close_rate = secondsToTime($close_rate);



// $close_rate = $this->audit_model->ticket_rate($table_tickets, $closed, $table_feedback, $table_ticket_action);
...
// $close_rate = $this->audit_model->ticket_rate($table_tickets, $table_ticket_action, $closed);
// $close_time = $this->audit_model->convertSecondsToTime($close_rate);
