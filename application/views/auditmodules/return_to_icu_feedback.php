					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3><a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'audit_id_tooltip'); ?>"> <i class="fa fa-question-circle" aria-hidden="true"></i></a> Return to ICU within 48 hours - <?php echo $result->id; ?> </h3>
							</div>
							<?php if (ismodule_active('AUDIT') === true  && isfeature_active('AUDIT-EDIT-PERMISSION') === true) { ?>
								<div class="btn-group" style="float: right;">
									<a class="btn btn-danger" style="margin-top:-40px;margin-right:10px;" href="<?php echo base_url($this->uri->segment(1) . "/edit_return_to_icu/$id") ?>"> <i class="fa fa-pencil" style="font-size:18px;"></i> Edit </a>
								</div>
							<?php } ?>
							<div class="panel-body" style="background: #fff;">
								...
								<table class=" table table-striped table-bordered  no-footer dtr-inline " style="font-size: 16px;">
									...
									<tr>
										...
										<td>
										<?php echo $result->complaintAdmission; ?>
										</td>
									</tr>
									<tr>
										<td><b>Treatment given at the time of admission</b></td>
										<td>
										<?php echo $result->treatmentAdmission; ?>
										</td>
									</tr>
									<tr>
										<td><b>Initial discharge date</b></td>
										<td>
										<?php echo $result->initial_discharge; ?>
										</td>
									</tr>
									<tr>
										<td><b>Re-admission date</b></td>
										<td>
										<?php echo $result->re_admission; ?>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
										<?php echo $result->complaintReadmission; ?>
										</td>
									</tr>
									<tr>
