            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3><a href="javascript:void()" data-toggle="tooltip"
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true"></i></a>&nbsp;Nurse-Patient ratio -
                        <?php echo $row->id; ?>
                    </h3>
                ...
                <div class="panel-body" style="background: #fff;">
                    ...
                    <table class="table table-striped table-bordered no-footer dtr-inline collapsed">
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="beds"
                                    value="<?php echo $param['beds']; ?>"></td>
                        </tr>
                        <tr>
                            <td><b>Number of nurses</b></td>
                            <td><input class="form-control" type="text" name="nurses"
                                    value="<?php echo $param['nurses']; ?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="date"
                                    value="<?php echo date('g:i a, d-M-Y', strtotime($result->datetime)); ?>"></td>
                        </tr>
