					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM13') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Tracks staff hand hygiene practices & compliance by role/department to prevent HAIs, aligned with NABH, JCI, CAHO, WHO 5 Moments & CDC infection control guidelines.</td>
								</tr>
								<tr>
					...
					<div class="panel-heading" style="display: flex; justify-content: space-between; align-items: center;">
						...
						<div>
							<a class="btn btn-success" target="_blank" data-placement="bottom" data-toggle="tooltip"
								...
								href="<?php echo base_url($this->uri->segment(1)) . '/overall_hand_hygiene' ?>">
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location='<?php echo $hygiene_feedback . $id; ?>';" style="cursor: pointer;">
										...
										<td style="overflow: clip;"><?php echo $param->testname; ?></td>
										<td><?php echo $param->designation; ?></td>
										<td><?php echo $param->department; ?></td>
										<td>
											<a href="<?php echo $hygiene_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_hand_hygiene"; // Replace with your API endpoint
