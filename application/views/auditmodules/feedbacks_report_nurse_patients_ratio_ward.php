			...
			<div class="col-lg-12 col-sm-12">
				<div class="panel panel-default">
					...
					<div class="panel-body" style="font-size:14px; line-height:1.5;">
						...
						$auditTitle = 'Nurse-Patient ratio for Ward';
						...
						if (!empty($users)) {
							foreach ($users as $user) {
								...
								foreach ($perms as $p) {
									if (strcasecmp(trim($p->feature_name), 'AUDIT-FORM23') === 0) {
						...
						<table class="table table-bordered table-condensed" style="margin:0;">
							<tbody>
								<tr>
									...
									<td>Monitors nurse-to-patient ratios in wards to ensure adequate staffing and safe patient care, aligned with NABH, JCI, CAHO & Indian hospital staffing standards.</td>
								</tr>
								<tr>
							...
							<tbody>
								...
								?>
									...
									<tr class="<?php echo ($sl & 1) ? 'odd gradeX' : 'even gradeC'; ?>" onclick="window.location.href='<?php echo base_url('audit/nurse_patient_ward_feedback?id=') . $id; ?>';" style="cursor: pointer;">
										...
										<td style="overflow: clip;"><?php echo $param->site; ?></td>
										<td style="overflow: clip;"><?php echo $param->ward; ?></td>

										<td>
											<a href="<?php echo $nurse_patient_ward_feedback . $id; ?>"
...
<script>
	...
	function resposnsechart(callback) {
		...
		var apiUrl = "https://" + domain + "/analytics_audit_quality/resposnsechart_nurse_patients_ratio"; // Replace with your API endpoint
