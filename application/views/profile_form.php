    ...
    <div class="col-sm-12">
        <div  class="panel panel-default">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-success" href="<?php echo base_url("dashboard/profile") ?>"> <i class="fa fa-list"></i>  <?php echo display('profile') ?> </a>  
                </div>
            </div> 
                    ...
                    <div class="col-md-9 col-sm-12">
                        ...
                        <?php echo form_open_multipart('dashboard/form/','class="form-inner"') ?> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="firstname" type="text" class="form-control" maxlength="25" id="firstname" placeholder="<?php echo display('first_name') ?>" value="<?php echo $doctor->firstname ?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="email" class="form-control" type="text" placeholder="<?php echo display('email')?>" id="email"  value="<?php echo $doctor->email ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="mobile" type="text" pattern="\d*" maxlength="10" class="form-control" type="text" placeholder="<?php echo display('mobile') ?>" id="mobile"  value="<?php echo $doctor->mobile ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row" style="display:none;">
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        ...
                                        <input type="radio" name="sex" value="Male" <?php echo  set_radio('sex', 'Male', TRUE); ?><?php if($doctor->sex  == 'Male'){ echo 'checked'; } ?> ><?php echo display('male') ?>
                                        </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="sex" value="Female" <?php echo  set_radio('sex', 'Female'); ?> <?php if($doctor->sex  == 'Female'){ echo 'checked'; } ?>><?php echo display('female') ?>
                                        </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="sex" value="Other" <?php echo  set_radio('sex', 'Other'); ?> <?php if($doctor->sex  == 'Other'){ echo 'checked'; } ?>><?php echo display('other') ?>
                                        </label>
                                    </div>
                                </div>
                            </div>
