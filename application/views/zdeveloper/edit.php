                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-12">
                            ...
                            <div class="form-group row">
                                <label for="firstname" class="col-xs-3 col-form-label">Patients Name <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="name" type="text" class="form-control" id="name" placeholder="Patients Name" value="<?php echo $patient->name ?>" required>
                                </div>
                            </div>
                            <!--<div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="firstname" class="col-xs-3 col-form-label">Hospital UID <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="patient_id" type="number" oninput="setCustomValidity('')" oninvalid="this.setCustomValidity('Hospital UID must be of 6 characters only.')" class="form-control" id="patient_id" placeholder="Enter patient ID" value="<?php echo $patient->patient_id ?>" <?php if ($patient->id) {
                                                                                                                                                                                                                                                                                                                echo 'readonly';
                                                                                                                                                                                                                                                                                                            } ?> required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="mobile" type="text" type="text" pattern="\d*" maxlength="10" class="form-control" id="admitedfor" placeholder="Mobile number" value="<?php echo $patient->mobile ?>" required>
                                </div>
                            </div>
                            <!-- mobile number end -->
                            ...
                            <div class="form-group row">
                                           ...
                                           -->
                            <div class="form-group row">
                                <label for="firstname" class="col-xs-3 col-form-label">Ward <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="admited_date" class="datetimepicker form-control" type="text" placeholder="" id="date_of_birth" value="<?php echo $patient->admited_date ?>" required>
                                </div>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-9">
                                        <?php if ($patient->discharged_date == 0) { ?>
                                            <input name="discharged_date" class="datetimepicker form-control" type="text" placeholder="" id="discharged_date" value="" required readonly>
                                        <?php } else { ?>

                                            <input name="discharged_date" class="datetimepicker form-control" type="text" placeholder="" id="discharged_date" value="<?php echo date('d-m-Y H:i', strtotime($patient->discharged_date)); ?>" required readonly>
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php  } ?>
