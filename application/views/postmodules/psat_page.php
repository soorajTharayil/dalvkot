			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;">
					<div class="statistic-box">
						...
						<div class="small">Total Feedbacks <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $totalfeedback_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
						<div class="icon">
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" data-toggle="tooltip" title="<?php echo $satisfiedpatients_info_tooltip; ?>">
					<div class="statistic-box">
						...
						<a href="<?php echo $ip_link_satisfied_list; ?>" style="float: right;    margin-top: -9px;">View List</a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="panel panel-bd">
				<div class="panel-body" style="height: 100px;" data-toggle="tooltip" title="<?php echo $unsatisfiedpatients_info_tooltip; ?>">
					<div class="statistic-box">
						...
						<div class="small">Unsatisfied Patients</div>
						<div class="icon">
							<i class="fa fa-frown-o"></i>
						</div>
						<a href="<?php echo $ip_link_unsatisfied_list; ?>" style="float: right;    margin-top: -9px;">View List</a>
					</div>
				</div>
			</div>
		</div>
