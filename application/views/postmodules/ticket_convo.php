	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">
			<?php if ($this->session->userdata('isLogIn') == false) { ?>
				<h3><?php echo lang_loader('ip', 'ip_ticket_thread'); ?></h3>
			<?php } else { ?>
		...
		<div class="panel-body" style="    height: auto;     overflow: auto;">
			...
			<div class="message_inner">
						...
						<a href="javascript:return false;">
							<div class="inbox-item">
								...
								<p class="inbox-item-text" style="overflow: clip; word-break: break-all;">
									<b><?php echo lang_loader('ip', 'ip_action'); ?></b>:
				...
				<?php if ($nodata == true) { ?>
					<h3 style="text-align: center; color:tomato;"><?php echo lang_loader('ip', 'ip_ticket_is_open'); ?></h3>
				<?php  }
				?>
