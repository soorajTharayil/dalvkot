...
<div class="content">
				...
				<div class="panel panel-bd">
					...
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"> <?php echo lang_loader('ip', 'ip_total_feedbacks'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo lang_loader('ip', 'ip_total_feedback_tooltip'); ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('ip', 'ip_psat_satisfied'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $satisfiedpatients_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('ip', 'ip_psat_unsatisfied'); ?> <a href="javascript:void()" data-toggle="tooltip" title="<?php echo $unsatisfiedpatients_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-frown-o"></i>
							</div>
							<a href="<?php echo $ip_link_unsatisfied_list; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('ip', 'ip_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip" title="<?php echo $ip_tickets_tool; ?>">
						<div class="statistic-box">
							...
							<a href="<?php echo $ip_link_ticket_dashboard; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('ip', 'ip_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;" data-placement="top" data-toggle="tooltip" title="<?php echo $ip_psat_tool; ?>">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('ip', 'ip_psat'); ?> <a href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $psat_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-star-half-o"></i>
							</div>
							<a href="<?php echo $ip_link_psat_page; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('ip', 'ip_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="panel panel-bd">
					<div class="panel-body" style="height: 100px;" style="height: 100px;" data-placement="top" data-toggle="tooltip" title="<?php echo $ip_nps_tool; ?>">
						<div class="statistic-box">
							...
							<div class="small"><?php echo lang_loader('ip', 'ip_nps'); ?> <a href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $nps_info_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></i></a></div>
							<div class="icon">
								<i class="fa fa-tachometer"></i>
							</div>
							<a href="<?php echo $ip_link_nps_page; ?>" style="float: right;    margin-top: -9px;"><?php echo lang_loader('ip', 'ip_view_list'); ?></a>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="panel-body" style="height: 150px; display:inline;">
							<div class="alert alert-success">
								<span style="font-size: 15px">
									<?php echo lang_loader('ip', 'ip_your'); ?> <strong><?php echo $key_highlights['best_param']; ?></strong> <?php echo lang_loader('ip', 'ip_received_the_highest_satisfaction_rating'); ?>
								</span>
							</div>
							<div class="alert alert-warning ">
								<span style="font-size: 15px">
									<?php echo lang_loader('ip', 'ip_your'); ?> <strong><?php echo $key_highlights['lowest_param']; ?></strong> <?php echo lang_loader('ip', 'ip_has_to_be_improved'); ?>
	...
	<div class="row">
		...
		<div class="col-lg-12 col-sm-12 col-md-12" style="overflow:auto;">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('ip', 'ip_patient_feedbacks_analysis'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $patientfeedbackanalysis_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a>
						<a id="downloadChartBtn" class="btn btn-primary btn-sm pull-right" style="margin-left: 10px;" href="javascript:void(0);">
	...
	<div class="row">
		...
		<div class="col-lg-6 col-sm-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('ip', 'ip_patient_satisfaction_analysis'); ?> <a href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $patientsatisficationanalysis_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
		...
		<div class="col-lg-6 col-sm-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('ip', 'ip_netpromoter_analysis'); ?> <a href="javascript:void()" data-toggle="tooltip" data-placement="bottom" title="<?php echo $netpromoteranalysis_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
				<div class="panel-body" style="  height:270px;" id="line">
					<div class="message_inner line_chart">
	...
	<div class="row">
		...
		<div class="col-lg-7 col-sm-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3> <?php echo lang_loader('ip', 'ip_tickets_received_by_department'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $ticketrecived_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
		...
		<div class="col-lg-5">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('ip', 'ip_recent_patient_feedbacks'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $recentpatientfeedback_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
				...
				<div style="padding: 20px;    background: #f5f5f5;"><a href="<?php echo base_url($this->uri->segment(1)); ?>/notifications" style="float: right;    margin-top: -9px;"><?php echo lang_loader('ip', 'ip_view_list'); ?></a></div>
			</div>
			<!-- /.row -->
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-lg-7 col-sm-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3> <?php echo lang_loader('ip', 'ip_hospital_selection_analysis'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $hospitalselectionanalysis_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
		...
		<div class="col-lg-5">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3><?php echo lang_loader('ip', 'ip_recent_patient_comments'); ?> <a href="javascript:void()" data-placement="bottom" data-toggle="tooltip" title="<?php echo $recentpatientcomment_tooltip; ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></a></h3>
				</div>
				<div class="panel-body" style="   height: 460px;      overflow: auto;">
					<div class="message_inner">
								...
								<a href="<?php echo base_url($this->uri->segment(1)); ?>/patient_feedback?id=<?php echo $r->id; ?>">
									<div class="inbox-item">
										...
										<?php if (!empty($param->suggestionText)) { ?>
											<p class="inbox-item-text" style="overflow: clip; word-break: break-all;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;<b><?php echo lang_loader('ip', 'ip_comment'); ?></b>:
												"<?php
				...
				<div style="padding: 20px;    background: #f5f5f5;"><a href="<?php echo base_url($this->uri->segment(1)); ?>/comments" style="float: right;    margin-top: -9px;"><?php echo lang_loader('ip', 'ip_view_all'); ?></a></div>
			</div>
