...
<div class="content">
	...
	$this->db->select('*');
	$this->db->where('department.type','incident');
					...
					<table class="datatables table table-striped table-bordered" cellspacing="0" width="100%">
						...
						<thead>
							<tr>
								...
								<th><?php echo lang_loader('inc','inc_issue'); ?></th>
								<th><?php echo lang_loader('inc','inc_tat_set'); ?></th>
							...
							<?php if (!empty($departments)) { ?>
								...
								<?php foreach ($departments as $department) { ?>
									...
									<tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
										...
										$value2 = $this->incident_model->convertSecondsToTime($department->close_time);
										$dep_tat = '';
										if ($value2['days'] != 0) {
