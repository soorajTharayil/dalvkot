    ...
    $scope.setupapplication = function () {
      ...
      $http
        .get(
          ...
          "/audit_load_emergency_code.php?patientid=" +
          id,
          { timeout: 20000 }
        )
        .then(
    ...
    $scope.savefeedback = function () {
      function isFeedbackValid() {
        ...
        if (
          ...
          $scope.feedback.location == undefined
        ) {
          alert("Please enter location");
          return false;
        }
        if (
          $scope.feedback.checklist == "" ||
          $scope.feedback.checklist == undefined
        ) {
      ...
      $http
        .post(
          $rootScope.baseurl_main +
          "/savepatientfeedback_mock_drill_audit.php?patient_id=" +
          $rootScope.patientid +
          "&administratorId=" +
          $rootScope.adminId,
          $scope.feedback
