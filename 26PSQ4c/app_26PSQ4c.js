...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateStockOutRate = function () {
      ...
      var stockOuts = document.getElementById("formula_para1").value;

      // Get the number of drugs listed as emergency drugs in hospital formulary
      var emergencyDrugsListed = document.getElementById("formula_para2").value;
      ...
      stockOuts = parseInt(stockOuts);
      emergencyDrugsListed = parseInt(emergencyDrugsListed);
      ...
      if (stockOuts === 0 && emergencyDrugsListed === 0) {
        ...
        $scope.calculatedResult = (
          (stockOuts / (emergencyDrugsListed || 1)) *
          100
        ).toFixed(2);
      }
