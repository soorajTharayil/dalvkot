...
app.controller('PatientFeedbackCtrl', function ($rootScope, $scope, $http, $location, $window) {
	...
	$scope.loadAuditCounts = function () {
		...
		$http.get($rootScope.baseurl_main + '/audit_count.php?patientid=' + id + '&month=' + $scope.selectedMonths + '&year=' + $scope.selectedYears + '&table=' + 'bf_feedback_xray_wait_time', { timeout: 20000 })
			.then(function (res) {
	...
	$scope.savefeedback = function () {
		...
		// Validation checks using inline new Date()
