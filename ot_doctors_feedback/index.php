							...
							<form id="msform">
									...
									<div class="form-card">
										<div class="row">
											...
											<div class="col-xs-12 col-sm-12 col-md-12">
												<!-- Patient Name -->
												<div class="form-group">
													<span class="addon" style="    font-size: 16px;"> {{lang.asistant_surgeon}}<sup style="color:red">*</sup></span>
													<span class="has-float-label">
														<input class="form-control" placeholder="Enter Asisstant Surgeon Name" name="asistant_surgeon" oninput="restrictToAlphabets(event)" maxlength="25" type="text" id="emailid" ng-model="feedback.asistant_surgeon" onblur="this.value = this.value.toUpperCase();" autocomplete="off" style=" padding-top:0px;" />
														<label for="emailid"></label>
													</span>
												</div>
											</div>
											<div class="col-xs-12 col-sm-12 col-md-12">
												<!-- Patient Name -->
												<div class="form-group">
													<span class="addon" style="    font-size: 16px;"> {{lang.scrub_nurse}}<sup style="color:red">*</sup></span>
													<span class="has-float-label">
														<input class="form-control" placeholder="Enter Scrub Nurse Name" name="scrub_nurse" oninput="restrictToAlphabets(event)" maxlength="25" type="text" id="emailid" ng-model="feedback.scrub_nurse" onblur="this.value = this.value.toUpperCase();" autocomplete="off" style=" padding-top:0px;" />
														<label for="emailid"></label>
													</span>
												</div>
											</div>
											<div class="col-xs-12 col-sm-12 col-md-12">
												<!-- Patient Name -->
												<div class="form-group">
													<span class="addon" style="    font-size: 16px;"> {{lang.surgery_name}}<sup style="color:red">*</sup></span>
													<span class="has-float-label">
														<input class="form-control" placeholder="Enter your input" name="surgery_name" oninput="restrictToAlphabets(event)" maxlength="25" type="text" id="emailid" ng-model="feedback.surgery_name" onblur="this.value = this.value.toUpperCase();" autocomplete="off" style=" padding-top:0px;" />
														<label for="emailid"></label>
													</span>
												</div>
											</div>
											...
											<div class="col-xs-12 col-sm-12 col-md-12">
												<div class="form-group">
													<span class="addon" style="    font-size: 16px;">{{lang.ot_num}}<sup style="color:red">*</sup></span>
													<span class="has-float-label">
														<input class="form-control" placeholder="Enter Room Number" type="text" id="contactnumber" maxlength="20" ng-required="true" ng-model="feedback.ot_num" autocomplete="off" placeholder="Numerical digits only" style="padding-top:0px;" />
											...
											<div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:1px;margin-top: 10px;">
												<div class="form-group transparent-placeholder" style="margin-top: -21px; display: flex; flex-direction: column; position: relative;">
													<span class="addon" style="font-size: 16px; margin-bottom: -18px;">Surgery Start Date & Time<br>
														<p style="font-size: 14px;">{{lang.format}}</p>
													</span>

													<div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
														<input class="form-control" ng-model="feedback.surgeryStartDate" type="datetime-local" id="formula_para1_hr" autocomplete="off" style="padding-top: 2px;padding-left: 6px;border: 1px solid #ced4da; margin-top:9px;width: calc(100% - 3px);" />
											...
											<div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:1px;margin-top: 30px;">
												<div class="form-group transparent-placeholder" style="margin-top: -21px; display: flex; flex-direction: column; position: relative;">
													<span class="addon" style="font-size: 16px; margin-bottom: -18px;">Surgery End Date & Time<br>
														<p style="font-size: 14px;">{{lang.format}}</p>
													</span>

													<div style="display: flex; flex-direction: row; align-items: center; width: 100%;">
														<input class="form-control" ng-model="feedback.surgeryEndDate" type="datetime-local" id="formula_para1_hr1" autocomplete="off" style="padding-top: 2px;padding-left: 6px;border: 1px solid #ced4da; margin-top:9px;width: calc(100% - 3px);" />
														<span class="calendar-icon-container" style="position: absolute; right: 5px; top: 76%; transform: translateY(-50%); margin-left:-29px;">
															<svg class="calendar-icon" style="margin-left:-19px;" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
																<path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zm0 1V1h8v-.5a.5.5 0 0 1 1 0V1h1a1 1 0 0 1 1 1v2H1V2a1 1 0 0 1 1-1h1V.5a.5.5 0 0 1 1 0V1zm-2 4v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V5H1z" />
															</svg>
								...
								<fieldset ng-show="step3 == true">
									<div class="form-card">
										...
										<h3 class="sectiondivision" style="text-align: left;margin-top:0px; font-size:18px; padding-top:36px; margin-left: 20px;"><b> {{lang.yourreason}} </b></h3>
										...
										<div class="col-xs-12 col-sm-12 col-md-12" style="padding-right:0px;padding-left:0px;">
											<div class="col-xs-12 col-sm-12  col-md-12" style="padding-right:0px;padding-left:0px;">
												<p style="font-size:18px;margin-top:12px; margin-left: 17px;"><b>{{lang.feedbacksuggestion}}</b></p>
											</div>
											<div class="col-xs-12 col-sm-12 col-md-12">
