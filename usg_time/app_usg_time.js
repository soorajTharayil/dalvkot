...
$scope.setupapplication1 = function () {
	...
	$scope.loadAuditCounts = function () {
		...
		$http.get($rootScope.baseurl_main + '/audit_count.php?patientid=' + id + '&month=' + $scope.selectedMonths + '&year=' + $scope.selectedYears + '&table=' + 'bf_feedback_usg_wait_time', { timeout: 20000 })
			.then(function (res) {
