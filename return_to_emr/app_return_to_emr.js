...
$scope.setupapplication1 = function () {
	...
	$scope.savefeedback = function () {
		...
		if (!$scope.feedback.initial_assessment_hr6) {
			...
			if ((!$scope.feedback.gloves || !$scope.feedback.mask || !$scope.feedback.same_op)) {
		...
		$http.post($rootScope.baseurl_main + '/savepatientfeedback_return_to_emr.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
