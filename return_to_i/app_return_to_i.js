    ...
    $scope.savefeedback = function () {
      ...
      function isFeedbackValid() {
        ...
        if (
          ...
          $scope.feedback.mid_no == undefined
        ) {
        ...
        if (
          ...
          $scope.feedback.initial_assessment_hr1 == undefined
        ) {
        ...
        if (
          ...
          $scope.feedback.department == undefined
        ) {
          alert("Please Select Department");
          return false;
        }
      ...
      if (
        new Date($scope.feedback.initial_assessment_hr3) <=
      ...
      $http
        .post(
          $rootScope.baseurl_main +
            "/savepatientfeedback_return_to_i.php?patient_id=" +
            $rootScope.patientid +
            "&administratorId=" +
            $rootScope.adminId,
          $scope.feedback
