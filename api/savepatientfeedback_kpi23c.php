...
if (count($data) > 1) {
   ...
   $query = 'INSERT INTO `bf_feedback_23cPSQ4c` (`name`,`email`,`patientid`,`mobile`,`sum_of_reporting_time`, `no_of_patients_in_diagnostics`, `usg_wait_time`, `bench_mark_time`, `data_analysis`,`corrective_action`,`preventive_action`, `dataset`,`datet`,`datetime`) 
