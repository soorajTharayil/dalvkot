...
if (count($data) > 1) {
   ...
   $query = 'INSERT INTO `bf_feedback_ctscan_time` (`name`,`patientid`,`mobile`,`email`,`datetime`,`datet`,`billing_time`,`procedure_entry_time`,`ctscan_wait_time`,`procedure_end_time`,`general_comment`, `dataset`) 
