...
$today = date('Y-m-d');
	...
	$contactnumber =	$data['contactnumber'];
	 ...
	 VALUES ("' . $name . '", "' . $email . '", "' . $patientid . '", "' . $contactnumber . '", "' . $datetime . '", "' . $no_medication_errors . '", "' . $no_opportunity_errors . '", "' . $calculatedResult . '", "' . $benchmark . '", "' . $dataAnalysis . '", "' . $correctiveAction . '", "' . $preventiveAction . '", "' . mysqli_real_escape_string($con, json_encode($data)) . '", "' . $today . '")';
