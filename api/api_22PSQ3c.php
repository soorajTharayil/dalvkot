...
$sql = "SELECT * FROM `bf_feedback_consultation_time` WHERE YEAR(register_time) = $selectedYear AND MONTH(register_time) = $selectedMonth";
...
if ($num1 > 0) {
    while ($row = mysqli_fetch_object($result)) {
        ...
        $time = $row->consultation_wait_time;
