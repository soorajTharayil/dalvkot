...
$today = date('Y-m-d');
	...
	$no_of_nursing_staff =	$data['initial_assessment_hr'];
	$no_of_beds =	$data['total_admission'];
   ...
   $query = 'INSERT INTO `bf_feedback_21aPSQ3c` (`name`,`email`,`patientid`,`mobile`,`no_of_nursing_staff`, `no_of_beds`, `nurse_patients_ratio`, `bench_mark_time`, `data_analysis`,`corrective_action`,`preventive_action`, `dataset`,`datet`,`datetime`) 
   VALUES ("' . $name . '","' . $email . '","' . $patientid . '","' . $contactnumber . '","' . $no_of_nursing_staff . '","' . $no_of_beds . '","' . $calculatedResult . '","' . $benchmark . '","' . $dataAnalysis . '","' . $correctiveAction . '","' . $preventiveAction . '","' . mysqli_real_escape_string($con, json_encode($data)) . '","' . $today . '","' . $datetime . '")';
