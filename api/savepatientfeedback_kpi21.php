...
$today = date('Y-m-d');
   ...
   $query = 'INSERT INTO `bf_feedback_21PSQ3c` (`name`,`email`,`patientid`,`mobile`,`no_of_nursing_staff`, `no_of_beds`, `nurse_patients_ratio`, `bench_mark_time`, `data_analysis`,`corrective_action`,`preventive_action`, `dataset`,`datet`,`datetime`) 
