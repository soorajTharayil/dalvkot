...
if (!empty($patient_id)) {
    ...
    $update_query = " UPDATE bf_feedback_asset_creation SET preventive_maintenance_date = '$last_maintenance', upcoming_preventive_maintenance_date = '$upcoming_maintenance' WHERE patientid = '$patient_id'";
