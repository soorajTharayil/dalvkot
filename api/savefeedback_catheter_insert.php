...
if (count($data) > 1) {
   ...
   $query = 'INSERT INTO `bf_feedback_catheter_insert` (`name`,`patientid`,`patientname`,`age`,`mobile`,`email`,`datetime`,`datet`,`ward`,`designation`,`staffname`,`identification_details`,`vital_signs`,`surgery`,`complaints_communicated`,`intake`,`output`,`allergies`,`medication`,`diagnostic`,`lab_results`,`pending_investigation`,`medicine_order`,`facility_communicated`,`health_education`,`risk_assessment`,`urethral`,`urine_sample`,`bystander`,`comments`, `dataset`) 
   VALUES ("' . $name . '","' . $patientid . '","' . $patientname . '","' . $age . '","'  . $contactnumber . '","' . $email . '","' . date('Y-m-d H:i:s') . '","' . $today . '","' . $ward . '","'. $designation . '","'. $staffname . '","'. $identification_details . '","'. $vital_signs . '","'. $surgery . '","'. $complaints_communicated . '","'. $intake . '","'. $output . '","' . $allergies . '","' . $medication . '","' . $diagnostic . '","' . $lab_results . '","' . $pending_investigation . '","' . $medicine_order . '","'. $facility_communicated . '","' . $health_education . '","' . $risk_assessment . '","' . $urethral . '","' . $urine_sample . '","' . $bystander . '","' . $comments . '","' . mysqli_real_escape_string($con, json_encode($data)) . '")';
