...
if (count($data) > 1) {
    ...
    $query = 'INSERT INTO `bf_feedback_50PSQ3a` (`name`,`email`,`patientid`,`mobile`,`actual_deaths_icu`, `predicted_deaths_icu`, `percentage_of_mortality_ratio`, `bench_mark_time`, `data_analysis`,`corrective_action`,`preventive_action`, `dataset`,`datet`,`datetime`) 
