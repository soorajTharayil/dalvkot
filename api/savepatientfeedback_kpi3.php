...
if (count($data) > 1) {
	...
	$no_staff_adher_safety =	$data['initial_assessment_hr'];
	$no_staff_audited =	$data['total_admission'];
	...
	$contactnumber =	$data['contactnumber'];
	 ...
	 $query = 'INSERT INTO `bf_feedback_3PSQ3a` 
	(`name`, `email`, `patientid`, `mobile`, `datetime`, `datet`, `no_staff_adher_safety`, 
	`number_of_staff_audited`, `percentage_safety_precatutions`, `bench_mark_time`, `data_analysis`, 
	`corrective_action`, `preventive_action`, `dataset`) 
	VALUES (
		"' . $name . '", 
		"' . $email . '", 
		"' . $patientid . '", 
