...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateSSIRate = function () {
      ...
      // Parse values
      var surgicalSiteInfections = parseInt(numVal);
      var surgeriesPerformed = parseInt(denVal);

      // Validation: infections cannot exceed surgeries
      ...
      // Allow 0 numerator + 0 denominator
