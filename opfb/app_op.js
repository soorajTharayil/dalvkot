...
app.controller('PatientFeedbackCtrl', function ($rootScope, $scope, $http, $location, $timeout) {
	...
	$scope.setupapplication = function () {
		...
		$http.get($rootScope.baseurl_main + '/department.php?patientid=' + id, { timeout: 20000 }).then(function (responsedata) {
			...
			if (responsedata.data.pinfo && responsedata.data.pinfo != null) {
				...
				$scope.feedback.section = "OUTPATIENT";
	...
	$scope.reloadQuestionsForDepartment = function (selectedDepartment) {
		...
		var departmentQuestionMapping = {
			"CARDIOLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Laboratory", "Pharmacy", "Other Facilities"],
			"ENT": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Pharmacy", "Other Facilities"],
			"GASTROENTEROLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Laboratory", "Radiology", "Pharmacy", "Other Facilities"],
			"GENERAL MEDICINE": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Laboratory", "Pharmacy", "Other Facilities"],
			"GENERAL SURGERY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Pharmacy", "Other Facilities"],
			"NEUROLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Laboratory", "Other Facilities"],
			"ONCOLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Laboratory", "Pharmacy", "Other Facilities"],
			"ORTHOPAEDICS": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Pharmacy", "Other Facilities"],
			"PEDIATRICS": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Laboratory", "Pharmacy", "Other Facilities"],
			"PHYSIOTHERAPY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Other Facilities"],
			"PHYSIOTHERAPY & REHABILITATION": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Other Facilities"],
			"PLASTIC SURGERY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Pharmacy", "Other Facilities"],
			"UROLOGY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Laboratory", "Radiology", "Pharmacy", "Other Facilities"],
			"VASCULAR SURGERY": ["Appointment Booking", "Registration & Reception", "Billing", "Doctor Consultation", "Radiology", "Pharmacy", "Other Facilities"]
		};
