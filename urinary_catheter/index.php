              ...
              <form id="msform">
                ...
                <fieldset ng-show="step1 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left: -14px;">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" style="margin-left:7px; top:-15px;">
                        <div class="form-group">
                          ...
                          <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
                            ...
                            <span class="has-float-label">
                          <input type="text" class="form-cont" ng-model="feedback.meatus_text"
                            placeholder="Remarks" style="margin-left:-2px;margin-top:5px;" />
                        </span>
                          </div>
                          <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
                            ...
                            <span class="has-float-label">
                          <input type="text" class="form-cont" ng-model="feedback.tubing_text"
                            placeholder="Remarks" style="margin-left:-2px;margin-top:5px;" />
                        </span>
                          </div>
                          <div style="margin-top: 8px; text-align: left;margin-left:-6px;">
                  ...
                  <!-- submit button -->
                  <input type="button" name="previous" class="previous action-button-previous" style=" font-size:small;margin-left:4px;margin-top:35px;" ng-click="prev1()" value="{{lang.previous}}" />
