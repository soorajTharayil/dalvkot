                ...
                <fieldset ng-show="step0 == true">
                  ...
                  <div class="form-card">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12" ng-show="feedback.site === 'ICU'" style="margin-top: -5px;">
                        <div class="form-group">
                          <span class="addon" style="font-size: 18px;">{{lang.icu}}<sup style="color:red">*</sup></span>
                          <span class="has-float-label">
