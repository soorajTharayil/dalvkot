...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculateProphylacticAntibioticsRate = function () {
      ...
      // Alert if numerator or denominator is EMPTY (not zero)
      ...
      var patientsWithProphylacticAntibiotics = parseInt(numVal);
      var patientsUnderwentSurgeries = parseInt(denVal);
      ...
      // Allow 0/0 case — output should be zero
      if (
