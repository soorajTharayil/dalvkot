...
$scope.feedback.audit_date = formatDateToLocalString($scope.feedback.audit_date);
		...
		$http.post($rootScope.baseurl_main + '/savefeedback_other_area_cleaning.php?patient_id=' + $rootScope.patientid + '&administratorId=' + $rootScope.adminId, $scope.feedback).then(function (responsedata) {
