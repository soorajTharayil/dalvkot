...
app.controller(
  ...
  function ($rootScope, $scope, $http, $location, $window, $timeout) {
    ...
    $scope.calculatePressureUlcersKPI = function () {
      ...
      // Only validate greater-than if denominator > 0
      if (totalPatientDays > 0 && pressureUlcers > totalPatientDays) {
        alert(
      ...
      // Zero-safe calculation
      var pressureUlcersKPI = 0;
